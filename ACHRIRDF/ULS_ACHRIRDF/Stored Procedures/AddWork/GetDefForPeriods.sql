...
IF @LASTRUN IS NULL
	SET @LASTRUN = (SELECT CAST('1753-1-1' AS DATETIME))
...
INSERT INTO @DF_PERIOD(BF_SSN, LN_SEQ, Begin_Date, End_Date)
SELECT
	BF_SSN,
	LN_SEQ,

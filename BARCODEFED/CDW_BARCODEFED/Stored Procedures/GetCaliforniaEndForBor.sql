CREATE PROCEDURE [barcodefed].[GetCaliforniaEndForBor]
...
SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED
	...
	SELECT DISTINCT
		...
		ISNULL(LN20.DX_ADR_EML, LN20.DX_CNC_EML_ADR) [Recipient],
		RTRIM(PD10.DM_PRS_1) [FirstName],
		RTRIM(PD10.DM_PRS_LST) [LastName],
					...
					INNER JOIN
						( -- email address
							...
							(
								...
								WHERE
									@AccountNumber IN (PD10_Bor.DF_SPE_ACC_ID, PD10_Bor.DF_PRS_ID)
							) Email
						) PD32

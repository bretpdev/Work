CREATE TABLE [dbo].[PH05_CNC_EML] (
    ...
    CONSTRAINT [PK_PH05_CNC_EML] PRIMARY KEY NONCLUSTERED ([DF_CNC_SYS_ID] ASC, [DF_SPE_ID] ASC)
);
...
GO
CREATE CLUSTERED INDEX [CIX_DFSPEID]
    ON [dbo].[PH05_CNC_EML]([DF_SPE_ID] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_DX_CNC_EML_ADR_DI_VLD_CNC_EML_ADR]
    ON [dbo].[PH05_CNC_EML]([DX_CNC_EML_ADR] ASC, [DI_VLD_CNC_EML_ADR] ASC) WITH (FILLFACTOR = 85, DATA_COMPRESSION = PAGE);

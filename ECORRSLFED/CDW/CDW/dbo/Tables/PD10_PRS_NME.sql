CREATE TABLE [dbo].[PD10_PRS_NME] (
    ...
    [DF_SRY_CUS_UNQ_ID] INT          NULL,
    CONSTRAINT [PK_PD10_PRS_NME] PRIMARY KEY CLUSTERED ([DF_PRS_ID] ASC)
);
...
CREATE NONCLUSTERED INDEX [CIX_DF_PRS_ID]
    ON [dbo].[PD10_PRS_NME]([DF_PRS_ID] ASC, [DF_SPE_ACC_ID] ASC)
    INCLUDE([DF_LST_DTS_PD10]) WITH (FILLFACTOR = 98, PAD_INDEX = ON);

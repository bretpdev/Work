...
GO
CREATE NONCLUSTERED INDEX [IX_LCSTALON50_LCDFRRSP_LDDFRBEG_LDDFREND]
    ON [dbo].[LN50_BR_DFR_APV]([LC_STA_LON50] ASC, [LC_DFR_RSP] ASC, [LD_DFR_BEG] ASC, [LD_DFR_END] ASC)
    INCLUDE([BF_SSN], [LN_SEQ], [LF_DFR_CTL_NUM]);

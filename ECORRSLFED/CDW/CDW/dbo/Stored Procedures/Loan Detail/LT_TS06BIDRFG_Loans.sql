CREATE PROCEDURE [dbo].[LT_TS06BIDRFG_Loans]
...
IF @IsCoborrower = 0
	BEGIN
		SELECT
			...
			COALESCE(LN72.LR_ITR, 0.0) AS [Interest Rate],
			'$' + CAST(COALESCE(LN10.LA_CUR_PRI,0) + COALESCE(DW01.WA_TOT_BRI_OTS,0) AS VARCHAR) AS [Current Principal Balance]
		FROM
			PD10_PRS_NME PD10

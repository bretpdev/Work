...
{
	public class EndorserSpouse : SerfFileBase
	{
        [Ignore]
        public int EndorserSpouseId { get; set; }
		...
		[FormatCode("X"), Length(6), Required, LinePos(892)]
		public string IC_LON_PGM { get; set; }

		[FormatCode("S9"), Length(4), Required, LinePos(898)]
		public string LN_SEQ { get; set; }

		[FormatCode("X"), Length(1), LinePos(902)]
		public string LC_EDS_TYP { get; set; }

		[FormatCode("X"), Length(2), LinePos(903)]
		public string LC_REL_TO_BR { get; set; }

		[FormatCode("X"), Length(9), LinePos(905)]
		public string LF_EDS { get; set; }

		[FormatCode("X"), Length(9), LinePos(914)]
		public string AF_APL_ID { get; set; }

		[FormatCode("S9"), Length(4), Required, LinePos(923)]
		public string EDS_LON26_DAT_OCC_CNT { get; set; }

		[Occurs(3), LinePos(927)]
		public List<LON26_EDS_DAT> ListOfLON26_EDS_DAT { get; set; }
		public class LON26_EDS_DAT
		{
			[FormatCode("S9"), Length(4), LinePos(0)]
			public string LN_LON_CRD_SEQ_EDS { get; set; }

			[FormatCode("X"), Length(6), LinePos(4)]
			public string IF_CRB_EDS { get; set; }

			[FormatCode("X"), Length(4), LinePos(10)]
			public string LF_CRD_SRE_EDS { get; set; }

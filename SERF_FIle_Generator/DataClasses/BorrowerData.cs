...
{
	public class BorrowerData : SerfFileBase
	{
        [Ignore]
        public int BorrowerDataId { get; set; }
		...
		[FormatCode("X"), Length(1), LinePos(892)]
		public string BI_PD_AHD_VER { get; set; }

		[FormatCode("X"), Length(10), LinePos(893)]
		public string BD_FED_LON_SLE { get; set; }

		[FormatCode("X"), Length(10), LinePos(903)]
		public string PF_FED_DEAL_NBR { get; set; }

		[FormatCode("X"), Length(8), LinePos(913)]
		public string PF_OWN_PRV  { get; set; }

		[FormatCode("X"), Length(8), LinePos(921)]
		public string PM_SER_PRV { get; set; }

		[FormatCode("X"), Length(8), LinePos(929)]
		public string PF_FED_SEC_INT_LON { get; set; }

		[FormatCode("X"), Length(1), LinePos(937)]
		public string PC_TYP_CVN { get; set; }

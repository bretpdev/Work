...
declare
	...
	@TableName VARCHAR(50) = 'PD26_PRS_SKP_PRC',
	@OverrideDateColumn VARCHAR(50) ='DF_LST_DTS_PD26' ,
	@OverrideLocalTableName VARCHAR(50) = 'PD26_PRS_SKP_PRC',
	@SSNField VARCHAR(50) = 'DF_PRS_ID',
	@SchemaOverride VARCHAR(10) = 'PKUB',
	@DD_STA_COLUMN VARCHAR(50) = 'DD_STA_SKP'

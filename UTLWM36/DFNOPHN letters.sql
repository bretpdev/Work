...
BEGIN TRANSACTION
	...
	DECLARE @ScriptId VARCHAR(50) = 'ICRNOPHN' --previous scriptId
	DECLARE @LetterName VARCHAR(20) = 'DFNOPHN1' --LetterId from letter tracking
	DECLARE @Pages INT = 2
	DECLARE @FileHeaderText VARCHAR(MAX) = 'SSN,DF_SPE_ACC_ID,DM_PRS_1,DM_PRS_LST,DX_STR_ADR_1,DX_STR_ADR_2,DM_CT,DC_DOM_ST,DF_ZIP,DM_FGN_CNY,TOT_PAYOFF,ACSKEY,STATE_IND,COST_CENTER_CODE'
	...
	DECLARE @Arc VARCHAR(5) = 'DLIV1'--Add the Arc ID here
...
BEGIN TRANSACTION
	...
	DECLARE @ScriptId2 VARCHAR(50) = 'ICRNOPHN' --previous scriptId
	DECLARE @LetterName2 VARCHAR(20) = 'DFNOPHN2' --LetterId from letter tracking
	DECLARE @Pages2 INT = 2
	DECLARE @FileHeaderText2 VARCHAR(MAX) = 'SSN,DF_SPE_ACC_ID,DM_PRS_1,DM_PRS_LST,DX_STR_ADR_1,DX_STR_ADR_2,DM_CT,DC_DOM_ST,DF_ZIP,DM_FGN_CNY,TOT_PAYOFF,ACSKEY,STATE_IND,COST_CENTER_CODE'
	...
	DECLARE @Arc2 VARCHAR(5) = 'DLIV2'--Add the Arc ID here
	...
	IF @ScriptdataId2 IS NULL
		BEGIN
			INSERT INTO ULS.[print].[ScriptData](ScriptID, SourceFile, LetterId, FileHeaderId, ProcessAllFiles, IsEndorser, [Priority], AddBarCodes, DoNotProcessEcorr, AddedBy, AddedAt, Active)
			VALUES(@ScriptId2, @SourceFile2, @LetterId2, @FileHeaderId2, 0, 0, @Priority2, 1, 1, SUSER_SNAME(), GETDATE(), 1)
...
BEGIN TRANSACTION
	...
	DECLARE @ScriptId3 VARCHAR(50) = 'ICRNOPHN' --previous scriptId
	DECLARE @LetterName3 VARCHAR(20) = 'DFNOPHN3' --LetterId from letter tracking
	DECLARE @Pages3 INT = 2
	DECLARE @FileHeaderText3 VARCHAR(MAX) = 'SSN,DF_SPE_ACC_ID,DM_PRS_1,DM_PRS_LST,DX_STR_ADR_1,DX_STR_ADR_2,DM_CT,DC_DOM_ST,DF_ZIP,DM_FGN_CNY,TOT_PAYOFF,ACSKEY,STATE_IND,COST_CENTER_CODE'
	...
	DECLARE @Arc3 VARCHAR(5) = 'DLIV3'--Add the Arc ID here
	...
	IF @ScriptdataId3 IS NULL
		BEGIN
			INSERT INTO ULS.[print].[ScriptData](ScriptID, SourceFile, LetterId, FileHeaderId, ProcessAllFiles, IsEndorser, [Priority], AddBarCodes, DoNotProcessEcorr, AddedBy, AddedAt, Active)
			VALUES(@ScriptId3, @SourceFile3, @LetterId3, @FileHeaderId3, 0, 0, @Priority3, 1, 1, SUSER_SNAME(), GETDATE(), 1)
...
BEGIN TRANSACTION
	...
	DECLARE @ScriptId4 VARCHAR(50) = 'ICRNOPHN' --previous scriptId
	DECLARE @LetterName4 VARCHAR(20) = 'DFNOPHN4' --LetterId from letter tracking
	DECLARE @Pages4 INT = 2
	DECLARE @FileHeaderText4 VARCHAR(MAX) = 'SSN,DF_SPE_ACC_ID,DM_PRS_1,DM_PRS_LST,DX_STR_ADR_1,DX_STR_ADR_2,DM_CT,DC_DOM_ST,DF_ZIP,DM_FGN_CNY,TOT_PAYOFF,ACSKEY,STATE_IND,COST_CENTER_CODE'
	...
	DECLARE @Arc4 VARCHAR(5) = 'DLIV4'--Add the Arc ID here
	...
	IF @ScriptdataId4 IS NULL
		BEGIN
			INSERT INTO ULS.[print].[ScriptData](ScriptID, SourceFile, LetterId, FileHeaderId, ProcessAllFiles, IsEndorser, [Priority], AddBarCodes, DoNotProcessEcorr, AddedBy, AddedAt, Active)
			VALUES(@ScriptId4, @SourceFile4, @LetterId4, @FileHeaderId4, 0, 0, @Priority4, 1, 1, SUSER_SNAME(), GETDATE(), 1)
...
BEGIN TRANSACTION
	...
	DECLARE @ScriptId5 VARCHAR(50) = 'ICRNOPHN' --previous scriptId
	DECLARE @LetterName5 VARCHAR(20) = 'DFNOPHN5' --LetterId from letter tracking
	DECLARE @Pages5 INT = 2
	DECLARE @FileHeaderText5 VARCHAR(MAX) = 'SSN,DF_SPE_ACC_ID,DM_PRS_1,DM_PRS_LST,DX_STR_ADR_1,DX_STR_ADR_2,DM_CT,DC_DOM_ST,DF_ZIP,DM_FGN_CNY,TOT_PAYOFF,ACSKEY,STATE_IND,COST_CENTER_CODE'
	...
	DECLARE @Arc5 VARCHAR(5) = 'DLIV5'--Add the Arc ID here
	...
	IF @ScriptdataId5 IS NULL
		BEGIN
			INSERT INTO ULS.[print].[ScriptData](ScriptID, SourceFile, LetterId, FileHeaderId, ProcessAllFiles, IsEndorser, [Priority], AddBarCodes, DoNotProcessEcorr, AddedBy, AddedAt, Active)
			VALUES(@ScriptId5, @SourceFile5, @LetterId5, @FileHeaderId5, 0, 0, @Priority5, 1, 1, SUSER_SNAME(), GETDATE(), 1)
...
BEGIN TRANSACTION
	...
	DECLARE @ScriptId6 VARCHAR(50) = 'ICRNOPHN' --previous scriptId
	DECLARE @LetterName6 VARCHAR(20) = 'DFNOPHN6' --LetterId from letter tracking
	DECLARE @Pages6 INT = 2
	DECLARE @FileHeaderText6 VARCHAR(MAX) = 'SSN,DF_SPE_ACC_ID,DM_PRS_1,DM_PRS_LST,DX_STR_ADR_1,DX_STR_ADR_2,DM_CT,DC_DOM_ST,DF_ZIP,DM_FGN_CNY,TOT_PAYOFF,ACSKEY,STATE_IND,COST_CENTER_CODE'
	...
	DECLARE @Arc6 VARCHAR(5) = 'DLIV6'--Add the Arc ID here
	...
	IF @ScriptdataId6 IS NULL
		BEGIN
			INSERT INTO ULS.[print].[ScriptData](ScriptID, SourceFile, LetterId, FileHeaderId, ProcessAllFiles, IsEndorser, [Priority], AddBarCodes, DoNotProcessEcorr, AddedBy, AddedAt, Active)
			VALUES(@ScriptId6, @SourceFile6, @LetterId6, @FileHeaderId6, 0, 0, @Priority6, 1, 1, SUSER_SNAME(), GETDATE(), 1)

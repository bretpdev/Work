CREATE PROCEDURE [phonesucsn].[LoadDuplicateDataEndorser]
AS
INSERT INTO ULS.phonesucsn.PhoneSuccession(Ssn, HomePhone, HomeExt, HomeSrc, HomeInd, HomeConsent, HomeIsValid, HomeVerifiedDate, AltPhone, AltExt, AltSrc, AltInd, AltConsent, AltIsValid, AltVerifiedDate, WorkPhone, WorkExt, WorkSrc, WorkInd, WorkConsent, WorkIsValid, WorkVerifiedDate, MorningRun, IsEndorser)
SELECT

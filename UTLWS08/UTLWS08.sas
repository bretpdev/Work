/*UTLWS08 BORROWER SERVICES DAILY WORK TRACKING REPORT*/
/*LIBNAME DLGSUTWH DB2 DATABASE=DLGSUTWH OWNER=OLWHRM1;*/
/*%LET RPTLIB = %SYSGET(reportdir);*/
%LET RPTLIB = T:\SAS;
FILENAME REPORT2 "&RPTLIB/ULWS08.LWS08R2";
FILENAME REPORTZ "&RPTLIB/ULWS08.LWS08RZ";
...
WHERE A.LD_ATY_RSP = &PRVDAY
AND E.PC_SER_DPT = 'BSV'
AND E.PD_USR_IN_DPT_END IS NULL
);
DISCONNECT FROM DB2;
/*%PUT  SQLXRC= >>> &SQLXRC <<< ||| SQLXMSG= >>> &SQLXMSG >>>  ;  * INCLUDES ERROR MESSAGES TO SAS LOG  ;*/
/*%SQLCHECK (SQLRPT=ULWS08.LWS08RZ);*/
/*QUIT;*/
ENDRSUBMIT;
...
BY DF_SPE_ACC_ID LN_ATY_SEQ USER_ID ACTION_CODE ACD ACTIVITY_TYPE RESPONSE_CODE DATE;
RUN;
...
TITLE 'BORROWER SERVICES DAILY TRACKING REPORT';
TITLE2 "RUN DATE: &RUNDT";
FOOTNOTE 'JOB = UTLWS08     REPORT = ULWS08.LWS08R2';
COLUMN USER_ID ACTION_CODE ACD ACTIVITY_TYPE RESPONSE_CODE DF_SPE_ACC_ID DATE COMMENTS;

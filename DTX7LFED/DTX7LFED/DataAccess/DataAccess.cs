...
namespace DTX7LFED
{
    class DataAccess 
    {
		...
		public DataAccess(int processlogId)
		{
            ...
            DB = DataAccessHelper.CurrentRegion == DataAccessHelper.Region.CornerStone ? DataAccessHelper.Database.Cls : DataAccessHelper.Database.Uls;
        }

        [UsesSproc(DataAccessHelper.Database.Uls, "spDTX7LGetDueDilLetters")]
        [UsesSproc(DataAccessHelper.Database.Cls, "spDTX7LGetDueDilLetters")]
        ...
        [UsesSproc(DataAccessHelper.Database.Cls, "spDTX7LGetExpiredLetters")]
        ...
        /// </summary>
        [UsesSproc(DataAccessHelper.Database.Cls, "DTX7LMarkRecordProcessed")]
        ...
        [UsesSproc(DataAccessHelper.Database.Cls, "DTX7LInsertDeletedRecord")]
        ...
        [UsesSproc(DataAccessHelper.Database.Cls, "Dtx7lGetDeletedRecords")]

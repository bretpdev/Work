<%@ Page Language="C#" MasterPageFile="~/Regents.Master" AutoEventWireup="true" CodeBehind="frmMathCredit.aspx.cs"
    Inherits="RegentsApp.MathCredit" Title="Regents' Application :: Math Credits"
    MaintainScrollPositionOnPostback="true" %>

<asp:Content ID="MathContent" ContentPlaceHolderID="regentsPlaceHolder" runat="server">
    <asp:UpdatePanel ID="up_Math" runat="server">
        <ContentTemplate>
            ...
            <script runat="server">
                ...
                {
                    SaveAndReturn(Convert.ToInt32(lblClass.Text.Remove(0, 11)));
            ...
            <script language="javascript" type="text/javascript">
                ...
                window.onload=function() {
                    if (document.getElementById('<%= ddlClassTypeSelection.ClientID %>').value == "11580" || document.getElementById('<%= ddlClassTypeSelection.ClientID %>').value == "11581" || document.getElementById('<%= ddlClassTypeSelection.ClientID %>').value == "11582") {
            ...
            <div id="divGradeLevel" runat="server" style="display: none; font-weight: normal;
                color: white; width: 70%; left: 15%; top: 600px; position: absolute;
                ...
                <p style="padding: 0px 15px 0px 15px; font-size: x-large;">
                    <b>NOTE: If the course is one that you will complete by the end of your 12th grade year
                        or are currently taking the course, but have not received a grade leave the term grade blank.</b>
                        </p>
            ...
            <h1 style="font-family: Verdana;">
                Educational Information - Page 2
            </h1>
            <div style="font-family: Verdana; width: 600px; margin-left: auto; margin-right: auto;">
                ...
                <table>
                    <tr>
                        <td style="border-color: Black; border-style: solid; border-width: thin; width: 450px;
                            ...
                            <h3>
                                Math - 4 Credits Required</h3>
                        </td>
                    </tr>
                </table>
                <p>
                    Enter the progressive Math courses you have taken, are taking, or will take in grades
                    9, 10, 11, and 12. You must continue adding classes until you reach the minimum
                    credit requirement. You must fill out all required information for each class. You
                    will not be able to move on to the next section of the application until the credit
                    requirement has been entered for Math.</p>
                <asp:SqlDataSource ID="dsStandardCourse" runat="server" ConnectionString="<%$ ConnectionStrings:RegentsAppConnectionString %>"
                    ...
                    <SelectParameters>
                        <asp:Parameter DefaultValue="2" Name="ClassTypeCode" Type="Int32" />
                ...
                <div id="divClass" style="border: solid 1px black;" runat="server">
                    <br />
                    <asp:Label ID="lblClass" runat="server" Text="Math Class 1" Font-Bold="True" Font-Size="XX-Large"></asp:Label>
                    <br />
                    <br />
                ...
                <asp:Label ID="lblCounter" runat="server" Text="   of 4 Math Credits Entered"></asp:Label>
                <br />
                <br />
                <asp:Button ID="btnNextPage" runat="server" Text="Social Science Section" OnClick="btnNextPage_Click"

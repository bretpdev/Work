CREATE TABLE [dbo].[FB10_BR_FOR_REQ] (
    ...
    CONSTRAINT [PK_FB10_BR_FOR_REQ] PRIMARY KEY CLUSTERED ([BF_SSN] ASC, [LF_FOR_CTL_NUM] ASC) WITH (FILLFACTOR = 95)
);
...
CREATE NONCLUSTERED INDEX [CIX_BF_SSN]
    ...
    INCLUDE([LF_FOR_CTL_NUM], [LC_FOR_TYP], [LD_CRT_REQ_FOR], [LC_FOR_STA], [LF_LST_DTS_FB10]) WITH (FILLFACTOR = 95);

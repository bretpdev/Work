CREATE TABLE [dbo].[LN66_LON_RPS_SPF] (
    ...
    CONSTRAINT [PK_LN66_LON_RPS_SPF] PRIMARY KEY CLUSTERED ([BF_SSN] ASC, [LN_SEQ] ASC, [LN_RPS_SEQ] ASC, [LN_GRD_RPS_SEQ] ASC) WITH (FILLFACTOR = 95)
);
...
CREATE NONCLUSTERED INDEX [IX_BFSSN_LNSEQ_LNRPSSEQ]
    ...
    INCLUDE([LN_GRD_RPS_SEQ], [LA_RPS_ISL], [LN_RPS_TRM]) WITH (FILLFACTOR = 95);

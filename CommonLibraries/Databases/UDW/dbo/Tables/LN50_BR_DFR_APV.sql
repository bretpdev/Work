CREATE TABLE [dbo].[LN50_BR_DFR_APV] (
    ...
    CONSTRAINT [PK_LN50_BR_DFR_APV] PRIMARY KEY CLUSTERED ([BF_SSN] ASC, [LN_SEQ] ASC, [LF_DFR_CTL_NUM] ASC, [LN_DFR_OCC_SEQ] ASC) WITH (FILLFACTOR = 95)
);


GO
CREATE NONCLUSTERED INDEX [IX_BFSSN_LCSTALON50>]
    ON [dbo].[LN50_BR_DFR_APV]([BF_SSN] ASC, [LC_STA_LON50] ASC) WITH (FILLFACTOR = 95);

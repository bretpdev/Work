...
CREATE NONCLUSTERED INDEX [CIX_RI_LTR_REQ_DEL_PRC]
    ...
    INCLUDE([DF_SPE_ACC_ID], [RM_APL_PGM_PRC], [RT_RUN_SRT_DTS_PRC], [RN_SEQ_LTR_CRT_PRC], [RN_SEQ_REC_PRC], [RM_DSC_LTR_PRC], [RF_SBJ_PRC], [OnEcorr], [PrintedAt], [EcorrDocumentCreatedAt]) WITH (FILLFACTOR = 95);

CREATE PROCEDURE [dbo].[LT_TS06BF101J_Forbearances]
...
IF @@ROWCOUNT = 0 
	BEGIN
		RAISERROR('No data returned. ([dbo].[LT_TS06BF101J_Forbearances])',11,2)
	END

GO
GRANT EXECUTE
    ON OBJECT::[dbo].[LT_TS06BF101J_Forbearances] TO [db_executor]
    AS [dbo];

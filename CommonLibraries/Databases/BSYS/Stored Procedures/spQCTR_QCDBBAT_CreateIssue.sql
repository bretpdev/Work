...
CREATE PROCEDURE [dbo].[spQCTR_QCDBBAT_CreateIssue]
...
SET @WindowsUserName = (SELECT WindowsUserName FROM SYSA_LST_UserIDInfo WHERE UserID = @ResponsibleUserID)
...
SET @History = @History + CHAR(13) + CHAR(13) + 'Created by the QC Database Batch Script'

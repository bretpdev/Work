...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[ArcAdd_AddLnSeqRecsFromString] TO [db_executor]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[ArcAdd_AddLnSeqRecsFromString] TO [UHEAA\SystemAnalysts]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[ArcAdd_AddLnSeqRecsFromString] TO [UHEAA\CornerStoneUsers]
    AS [dbo];

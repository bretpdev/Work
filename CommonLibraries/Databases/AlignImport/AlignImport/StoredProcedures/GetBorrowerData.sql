...
AS
    SELECT DISTINCT
        ...
        CASE
            WHEN br_drivers_license = '' THEN '00000000000000000000'
            ELSE br_drivers_license
        END  AS DF_DRV_LIC,
        ...
        CASE
            ...
            ELSE 'N'
        END AS DI_US_CTZ,
        LEFT([br_name_first], 13) AS DM_PRS_1, 
        LEFT([br_name_last], 23) AS DM_PRS_LST,
        '' AS DM_PRS_LST_SFX,
        ...
        [br_perm_zip_code] AS DF_ZIP_CDE, 
        case
        ...
        '' AS DN_FGN_PHN_INL,
        '' AS DN_FGN_PHN_LCL,
        LEFT([br_perm_phone_ext], 5) AS DN_PHN_XTN,
        '' AS DT_PHN_BST_CL,
        '' AS DX_PHN_TME_ZNE,
        'N' AS DC_ALW_ADL_PHN,
        'H' AS DC_ADR_EML,
    ...
    UNION ALL
       ...
       CASE
        ...
        '' AS DN_FGN_PHN_INL,
        '' AS DN_FGN_PHN_LCL,
        LEFT([br_temp_phone_ext],5) AS DN_PHN_XTN, 
        '' AS DT_PHN_BST_CL,
        '' AS DX_PHN_TME_ZNE,
        'N' AS DC_ALW_ADL_PHN,
        'H' AS DC_ADR_EML,

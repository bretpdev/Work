...
AS
    SELECT DISTINCT
        ...
        '' AS LD_RTN_RPD_DIS, 
        ISNULL(MAX_DISC.Max_Disc_Date, dbo.CONVERT_DATE([gr_conversion_date])) AS LD_SNT_RPD_DIS,
        DATEADD(MONTH,1, ISNULL(MAX_DISC.Max_Disc_Date, dbo.CONVERT_DATE([gr_conversion_date]))) AS LD_STA_RPST10,
        'N' AS LI_SIG_RPD_DIS,
        '' AS LN_RPS_SEQ, 

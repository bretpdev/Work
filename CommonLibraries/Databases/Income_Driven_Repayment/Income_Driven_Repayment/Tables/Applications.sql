CREATE TABLE [dbo].[Applications] (
    ...
    [tax_year]                               INT          NULL,
	[taxes_filed_flag]						 BIT		  NULL DEFAULT 0,
	...
	[borrower_selected_lowest_plan]			 BIT		  NULL DEFAULT 0,
...
BEGIN
	...
	DECLARE @repayment_plan_type_status_date date = (SELECT repayment_plan_date_entered FROM inserted)
...
BEGIN
	...
	DECLARE @repayment_plan_type_status_date_new date = (SELECT repayment_plan_date_entered FROM inserted)
	DECLARE @repayment_plan_type_status_date_old date = (SELECT repayment_plan_date_entered FROM deleted)

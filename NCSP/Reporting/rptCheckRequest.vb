...
Public Class rptCheckRequest
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NCSP.rptCheckRequest.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCheckRequest
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCheckRequest = New rptCheckRequest
        rpt.Site = Me.Site
        Return rpt
    End Function

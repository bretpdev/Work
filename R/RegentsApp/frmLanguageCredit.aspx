<%@ Page Language="C#" MasterPageFile="~/Regents.Master" AutoEventWireup="true" CodeBehind="frmLanguageCredit.aspx.cs"
    Inherits="RegentsApp.LanguageCredit" Title="Regents' Application :: Language Credits"
    MaintainScrollPositionOnPostback="true" %>

<asp:Content ID="LanguageContent" ContentPlaceHolderID="regentsPlaceHolder" runat="server">
    <asp:UpdatePanel ID="up_Language" runat="server">
        <ContentTemplate>
            ...
            <script language="javascript" type="text/javascript">
                ...
                window.onload=function() {
                    if (document.getElementById('<%= ddlClassTypeSelection.ClientID %>').value == "11589" || document.getElementById('<%= ddlClassTypeSelection.ClientID %>').value == "11590" || document.getElementById('<%= ddlClassTypeSelection.ClientID %>').value == "11591") {
            ...
            <div id="divGradeLevel" runat="server" style="display: none; font-weight: normal;
                color: white; width: 70%; left: 15%; top: 700px; position: absolute;
                padding: 1em; background: #5d87a1; border: 5px ridge gray;">
            ...
            <h1 style="font-family: Verdana;">
                Educational Information - Page 5
            </h1>
            <div style="font-family: Verdana; width: 600px; margin-left: auto; margin-right: auto;">
                ...
                <table>
                    <tr>
                        <td style="border-color: Black; border-style: solid; border-width: thin; width: 450px;
                            ...
                            <h3>
                                World or Classical Language - 2 Credits Required</h3>
                        </td>
                    </tr>
                </table>
                <p>
                    Enter the progressive World or Classical Language courses you have taken, are taking,
                    or will take in grades 9, 10, 11, and 12. <u>Courses completed in 7th and 8th grades
                        do not count towards the fulfillment of the scholarship requirements.</u> You
                    must continue adding courses until you reach the minimum credit requirement. You
                    must fill out all required information for each course. You will not be able to
                    move on to the next section of the application until the credit requirement has
                    been entered for World or Classical Language.</p>
                <asp:SqlDataSource ID="dsStandardCourse" runat="server" ConnectionString="<%$ ConnectionStrings:RegentsAppConnectionString %>"
                    ...
                    <SelectParameters>
                        <asp:Parameter DefaultValue="5" Name="ClassTypeCode" Type="Int32" />
                ...
                <div id="divClass" style="border: solid 1px black;" runat="server">
                    <br />
                    <asp:Label ID="lblClass" runat="server" Text="Language Class 1" Font-Bold="True"
                        ...
                        <tr>
                            ...
                            <td style="text-align: left; padding-left: 10px;">
                                ...
                                <asp:RequiredFieldValidator ID="vaAttend" runat="server" ControlToValidate="ddlUnivPlanAttend"
                                    ErrorMessage="Please select the college or university where the class was taken" Enabled="False">*</asp:RequiredFieldValidator>
                                <br />
                            </td>
                        </tr>
                    </table>
                ...
                <br />
                <br />
                <asp:Label ID="lblNotSaved0" runat="server" Font-Size="Small" Text="These buttons are for navigational purposes only. In order to save changes you make to the class information you must use the “Save Class” button before navigating to a different class."></asp:Label>
                <table>
                    <tr>
                        <td>
                ...
                <asp:Label ID="lblCounter" runat="server" Text="   of 2 Language Credits Entered"></asp:Label>
                <br />
                <br />
                <asp:Button ID="btnNextPage" runat="server" Text="Application Review" OnClick="btnNextPage_Click"

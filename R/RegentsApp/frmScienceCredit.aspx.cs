...
{
    public partial class ScienceCredit : System.Web.UI.Page
    {
        #region Properties
        int _classTitle;
        ...
        protected void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            catch (Exception)
            {
                ...
                cData = dal.GetClass(_userName, 3, 1);
                gData1 = dal.GetGrade(_userName, 3, 1, 1);
                gData2 = dal.GetGrade(_userName, 3, 1, 2);
                gData3 = dal.GetGrade(_userName, 3, 1, 3);
                gData4 = dal.GetGrade(_userName, 3, 1, 4);
                gData5 = dal.GetGrade(_userName, 3, 1, 5);
                gData6 = dal.GetGrade(_userName, 3, 1, 6);
                if (cData != null) { weightCode = cData.WeightCode; }
                if (weightCode == "  ") { weightCode = string.Empty; }
                classSubject = FillClassSubject(weightCode, "Biology");
                if (cData != null)
                {
                    ...
                    if (cData.WeightCode == "  ")
                    {
                        ...
                        ddlClassTypeSelection.DataSource = classSubject;
                        ...
                        if (dal.GetClassBoolean(cData.ClassTitleCode) == false)
                        {
                            ...
                            ddlClassTypeSelection.SelectedValue = dal.GetClassCode(3, null).ToString();
                        ...
                        else
                        {
                            ...
                            {
                                ddlClassTypeSelection.SelectedIndex = 0;
                            }
                            tbClassName.Text = "";
                        }
                    }
                    else if (cData.WeightCode == "AP")
                    {
                        ...
                        {
                            tbClassName.Text = dal.GetClassDescription(cData.ClassTitleCode);
                            ddlClassTypeSelection.SelectedValue = dal.GetClassCode(3, "AP").ToString();
                            divClassName.Style.Add(HtmlTextWriterStyle.Display, "inline");
                        }
                        else
                        {
                    ...
                    else if (cData.WeightCode == "CE")
                    {
                        ...
                        {
                            tbClassName.Text = dal.GetClassDescription(cData.ClassTitleCode);
                            ddlClassTypeSelection.SelectedValue = dal.GetClassCode(3, "CE").ToString();
                            divClassName.Style.Add(HtmlTextWriterStyle.Display, "inline");
                        }
                        else
                        {
                ...
                ClassData cData2 = dal.GetClass(_userName, 3, 2);
                ClassData cData3 = dal.GetClass(_userName, 3, 3);
                ClassData cData4 = dal.GetClass(_userName, 3, 4);
                ClassData cData5 = dal.GetClass(_userName, 3, 5);
                ClassData cData6 = dal.GetClass(_userName, 3, 6);
                ClassData cData7 = dal.GetClass(_userName, 3, 7);
                ClassData cData8 = dal.GetClass(_userName, 3, 8);
                if (cData2 != null)
                {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            #region Science Session Variables
            ...
            lblCreditsCounted.Text = dal.GetCreditsTotal(_userName, 3).ToString();
            if (Convert.ToDouble(lblCreditsCounted.Text) >= 3 && _seq > 3)
            {
            ...
            if (ddlClassTypeSelection.Text == "11583" || ddlClassTypeSelection.Text == "11584" || ddlClassTypeSelection.Text == "11585")
            {
                divClassName.Style.Add(HtmlTextWriterStyle.Display, "inline");
            }
            ...
            if (!IsPostBack)
            {
                classSubject.Insert(0, new ClassList() { Code = 0, Description = "" });
                ddlClassTypeSelection.DataSource = classSubject;
                ddlClassTypeSelection.DataTextField = "Description";
                ddlClassTypeSelection.DataValueField = "Code";
                ddlClassTypeSelection.DataSourceID = "";
        ...
        private void FillClassListDropDown(string weightCode)
        {
            if (lblClassType.Text.Contains("Biology")) { classSubject = FillClassSubject(weightCode, "Biology"); }
            else if (lblClassType.Text.Contains("Chemistry")) { classSubject = FillClassSubject(weightCode, "Chemistry"); }
            else if (lblClassType.Text.Contains("Physics")) { classSubject = FillClassSubject(weightCode, "Physics"); }
            else { classSubject = FillClassSubject(weightCode, string.Empty); }
            classSubject.Insert(0, new ClassList() { Code = 0, Description = "" });
            if (lblClassType.Text == "" && weightCode == "CE") { classSubject.RemoveAt(16); }
            ddlClassTypeSelection.DataSource = classSubject;
            ddlClassTypeSelection.DataTextField = "Description";
            ddlClassTypeSelection.DataValueField = "Code";
            ddlClassTypeSelection.DataSourceID = "";
        ...
        private List<ClassList> FillClassSubject(string weightCode, string classType)
        {
            List<ClassList> classes = dal.GetScienceClassList(3, true, weightCode, classType);
            if (weightCode == "") { classes.Insert(classes.Count, new ClassList { Code = 11583, Description = "Other" }); }
            if (weightCode == "AP") { classes.Insert(classes.Count, new ClassList { Code = 11584, Description = "Other" }); }
            if (weightCode == "CE") { classes.Insert(classes.Count, new ClassList { Code = 11585, Description = "Other" }); }
            return classes;
        }
        ...
        {
            divGradeLevel.Style.Remove(HtmlTextWriterStyle.Display);
            divConcurrent.Style.Remove(HtmlTextWriterStyle.Display);
        ...
        /// and redirects to the Science subject.
        /// </summary>
        protected void btnNextPage_Click(object sender, EventArgs e)
        {
            if (ValidateClass(true))
            {
                if (SaveAndReturn(Convert.ToInt32(lblClass.Text.Remove(0, 14))))
                {
                    ClassData cData1 = dal.GetClass(_userName, 3, 1);
                    ClassData cData2 = dal.GetClass(_userName, 3, 2);
                    ClassData cData3 = dal.GetClass(_userName, 3, 3);
                    ClassData cData4 = dal.GetClass(_userName, 3, 4);
                    ClassData cData5 = dal.GetClass(_userName, 3, 5);
                    ...
                    {
                        lblCreditsCounted.Text = dal.GetCreditsTotal(_userName, 3).ToString();
                        if (Convert.ToDouble(lblCreditsCounted.Text) >= 3)
                        {
        ...
        protected void btnBack_Click(object sender, EventArgs e)
        {
            ...
            {
                DeleteClassSessionVariables();
                Response.Redirect("frmSocSciCredit.aspx");
            }
            else
            {
        ...
        {
            lblClass.Text = "Science Class 1";
            lblClassType.Text = "Biology";
        ...
        {
            lblClass.Text = "Science Class 2";
            lblClassType.Text = "Chemistry";
        ...
        {
            lblClass.Text = "Science Class 3";
            lblClassType.Text = "Physics";
        ...
        public bool SaveAndReturn(int seq)
        {
            ...
            {
                int code;
                if ((code = dal.CheckClassNameByCode(tbClassName.Text.Replace("'", "''"))) != 3 && code != 0)
                {
            ...
            try
            {
                ...
                if (ddlClassTypeSelection.SelectedItem.Text.Contains("Other"))
                {
                    ...
                    {
                        if (dal.InsertClassName(_classTitleOther.ToString().Replace("'", ""), 3, _weight))
                        {
                    ...
                    if (dal.UpdateClass(_userName, 3, seq, _classTitle, _gradeLevel, _weight, _credits, _collegeCode))
                    {
                        classSaved = true;
                    }
                    else
            ...
            catch (Exception)
            {
                if (ddlClassTypeSelection.SelectedItem.Text.Contains("Other"))
                {
                    ...
                    if (dal.InsertClass(_userName, 3, seq, _classTitle, _gradeLevel, _weight, _credits, _collegeCode))
                    {
                        classSaved = true;
                    }
                    else
            ...
            try
            {
                if (ddl1Grade1.Text != "0")
                {
                    ...
                    if (dal.UpdateGrade(_userName, 3, seq, 1, _grade1))
                    {
                        grade1Saved = true;
                    }
                    else
                ...
                else if (dal.DeleteGrade(_userName, 3, seq, 1))
                {
                    grade1Saved = true;
                }
            }
            ...
            {
                if (dal.InsertGrade(_userName, 3, seq, 1, _grade1))
                {
                    grade1Saved = true;
                }
                else
            ...
            try
            {
                if (ddl1Grade2.Text != "0")
                {
                    ...
                    if (dal.UpdateGrade(_userName, 3, seq, 2, _grade2))
                    {
                        grade2Saved = true;
                    }
                    else
                ...
                else if (dal.DeleteGrade(_userName, 3, seq, 2))
                {
                    grade2Saved = true;
                }
            }
            ...
            {
                if (dal.InsertGrade(_userName, 3, seq, 2, _grade2))
                {
                    grade2Saved = true;
                }
                else
            ...
            try
            {
                if (ddl1Grade3.Text != "0")
                {
                    ...
                    if (dal.UpdateGrade(_userName, 3, seq, 3, _grade3))
                    {
                        grade3Saved = true;
                    }
                    else
                ...
                else if (dal.DeleteGrade(_userName, 3, seq, 3))
                {
                    grade3Saved = true;
                }
            }
            ...
            {
                if (dal.InsertGrade(_userName, 3, seq, 3, _grade3))
                {
                    grade3Saved = true;
                }
                else
            ...
            try
            {
                if (ddl1Grade4.Text != "0")
                {
                    ...
                    if (dal.UpdateGrade(_userName, 3, seq, 4, _grade4))
                    {
                        grade4Saved = true;
                    }
                    else
                ...
                else if (dal.DeleteGrade(_userName, 3, seq, 4))
                {
                    grade4Saved = true;
                }
            }
            ...
            {
                if (dal.InsertGrade(_userName, 3, seq, 4, _grade4))
                {
                    grade4Saved = true;
                }
                else
            ...
            try
            {
                if (ddl1Grade5.Text != "0")
                {
                    ...
                    if (dal.UpdateGrade(_userName, 3, seq, 5, _grade5))
                    {
                        grade5Saved = true;
                    }
                    else
                ...
                else if (dal.DeleteGrade(_userName, 3, seq, 5))
                {
                    grade5Saved = true;
                }
            }
            ...
            {
                if (dal.InsertGrade(_userName, 3, seq, 5, _grade5))
                {
                    grade5Saved = true;
                }
                else
            ...
            try
            {
                if (ddl1Grade6.Text != "0")
                {
                    ...
                    if (dal.UpdateGrade(_userName, 3, seq, 6, _grade6))
                    {
                        grade6Saved = true;
                    }
                    else
                ...
                else if (dal.DeleteGrade(_userName, 3, seq, 6))
                {
                    grade6Saved = true;
                }
            }
            ...
            {
                if (dal.InsertGrade(_userName, 3, seq, 6, _grade6))
                {
                    grade6Saved = true;
                }
                else
        ...
        {
            bool validated = true;
            if (ddlClassTypeSelection.Text == "0" && !nextPage)
            {
                vaClassList.Enabled = true;
                vaClassList.IsValid = false;
                validated = false;
            }
            else if (ddlClassTypeSelection.Text == "0" && nextPage && (ddlGradeLevel.Text != "" || tbCredits.Text != ""))
            {
                vaClassList.Enabled = true;
                vaClassList.IsValid = false;
                validated = false;
            ...
            if (((ddlClassTypeSelection.Text == "11583" || ddlClassTypeSelection.Text == "11584" || ddlClassTypeSelection.Text == "11585") && tbClassName.Text == "") && !nextPage)
            {
        ...
        {
            gData1 = dal.GetGrade(_userName, 3, seq, 1);
            gData2 = dal.GetGrade(_userName, 3, seq, 2);
            gData3 = dal.GetGrade(_userName, 3, seq, 3);
            gData4 = dal.GetGrade(_userName, 3, seq, 4);
            gData5 = dal.GetGrade(_userName, 3, seq, 5);
            gData6 = dal.GetGrade(_userName, 3, seq, 6);
            bool isValid = false;
            if (newData.ClassTitleCode == 11598 || newData.ClassTitleCode == 11599 || newData.ClassTitleCode == 11600)
            {
                isValid = false;
            }
        ...
        {
            bool saved = false;
            int count = lblClass.Text.Length - 1;
            if (SaveAndReturn(Convert.ToInt32(lblClass.Text.Remove(0, count))))
            {
                string curClass = lblClass.Text.Remove(0, count);
        ...
        private void ClearClassList()
        {
            rdoConcurrent.Checked = false;
            rdoAdvanced.Checked = false;
            FillClassListDropDown(string.Empty);
            tbClassName.Text = "";
            divClassName.Style.Add(HtmlTextWriterStyle.Display, "none");
            universityTable.Style.Add(HtmlTextWriterStyle.Display, "none");
            lblInvalidClass.Visible = false;
        ...
        private void SwitchClassLabel(string str)
        {
            switch (str)
            {
                ...
                case "2":
                    ...
                    break;
                case "3":
                    lblClassType.Text = string.Empty;
                    lblClassType.Style.Add(HtmlTextWriterStyle.Display, "none");
                    lblClass.Text = "Science Class 4";
                    break;
                case "4":
                    lblClassType.Text = string.Empty;
        ...
        private void RetrieveNextClass(int seq)
        {
            ...
            _seq = seq;
            Session["Sequence"] = _seq;
            cData = dal.GetClass(_userName, 3, _seq);
            gData1 = dal.GetGrade(_userName, 3, _seq, 1);
            gData2 = dal.GetGrade(_userName, 3, _seq, 2);
            gData3 = dal.GetGrade(_userName, 3, _seq, 3);
            gData4 = dal.GetGrade(_userName, 3, _seq, 4);
            gData5 = dal.GetGrade(_userName, 3, _seq, 5);
            gData6 = dal.GetGrade(_userName, 3, _seq, 6);
            FillClassListDropDown(string.Empty);
            if (cData != null)
            {
            ...
            lblCreditsCounted.Text = dal.GetCreditsTotal(_userName, 3).ToString();
            if (Convert.ToDouble(lblCreditsCounted.Text) >= 3 && seq > 3)
            {
                btnNextPage.Enabled = true;
            }
            else
        ...
        {
            dal.DeleteClass(_userName, 3, seq);
            dal.DeleteAllGrades(_userName, 3, seq);
        }

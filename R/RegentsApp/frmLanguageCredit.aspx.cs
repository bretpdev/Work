...
{
    public partial class LanguageCredit : System.Web.UI.Page
    {
        #region Properties
        int _classTitle;
        ...
        protected void Page_PreLoad(object sender, EventArgs e)
        {
            ...
            catch (Exception)
            {
                ...
                cData = dal.GetClass(_userName, 5, 1);
                gData1 = dal.GetGrade(_userName, 5, 1, 1);
                gData2 = dal.GetGrade(_userName, 5, 1, 2);
                gData3 = dal.GetGrade(_userName, 5, 1, 3);
                gData4 = dal.GetGrade(_userName, 5, 1, 4);
                gData5 = dal.GetGrade(_userName, 5, 1, 5);
                gData6 = dal.GetGrade(_userName, 5, 1, 6);
                if (cData != null)
                {
                    ...
                    if (cData.WeightCode == "  ")
                    {
                        ...
                        if (dal.GetClassBoolean(cData.ClassTitleCode) == false)
                        {
                            ...
                            ddlClassTypeSelection.SelectedValue = dal.GetClassCode(5, null).ToString();
                    ...
                    else if (cData.WeightCode == "AP")
                    {
                        ...
                        {
                            tbClassName.Text = dal.GetClassDescription(cData.ClassTitleCode);
                            ddlClassTypeSelection.SelectedValue = dal.GetClassCode(5, "AP").ToString();
                            divClassName.Style.Add(HtmlTextWriterStyle.Display, "inline");
                        }
                        else
                        {
                    ...
                    else if (cData.WeightCode == "CE")
                    {
                        ...
                        {
                            tbClassName.Text = dal.GetClassDescription(cData.ClassTitleCode);
                            ddlClassTypeSelection.SelectedValue = dal.GetClassCode(5, "CE").ToString();
                            divClassName.Style.Add(HtmlTextWriterStyle.Display, "inline");
                        }
                        else
                        {
                ...
                ClassData cData2 = dal.GetClass(_userName, 5, 2);
                ClassData cData3 = dal.GetClass(_userName, 5, 3);
                ClassData cData4 = dal.GetClass(_userName, 5, 4);
                ClassData cData5 = dal.GetClass(_userName, 5, 5);
                if (cData2 != null)
                {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            #region Language Session Variables
            ...
            lblCreditsCounted.Text = dal.GetCreditsTotal(_userName, 5).ToString();
            if (Convert.ToDouble(lblCreditsCounted.Text) >= 2)
            {
            ...
            if (ddlClassTypeSelection.Text == "11589" || ddlClassTypeSelection.Text == "11590" || ddlClassTypeSelection.Text == "11591")
            {
                divClassName.Style.Add(HtmlTextWriterStyle.Display, "inline");
            }
        ...
        protected void btnNextPage_Click(object sender, EventArgs e)
        {
            if (ValidateClass(true))
            {
                ...
                {
                    ClassData cData1 = dal.GetClass(_userName, 5, 1);
                    ClassData cData2 = dal.GetClass(_userName, 5, 2);
                    ClassData cData3 = dal.GetClass(_userName, 5, 3);
                    ClassData cData4 = dal.GetClass(_userName, 5, 4);
                    ClassData cData5 = dal.GetClass(_userName, 5, 5);
        ...
        {
            if (SaveAndReturn(Convert.ToInt32(lblClass.Text.Remove(0, 15))))
            {
                DeleteClassSessionVariables();
        ...
        {
            lblClass.Text = "Language Class 1";
        ...
        {
            lblClass.Text = "Language Class 2";
        ...
        {
            lblClass.Text = "Language Class 3";
        ...
        {
            lblClass.Text = "Language Class 4";
        ...
        {
            lblClass.Text = "Language Class 5";
        ...
        public bool SaveAndReturn(int seq)
        {
            ...
            {
                int code;
                if ((code = dal.CheckClassNameByCode(tbClassName.Text.Replace("'", "''"))) != 5 && code != 0)
                {
            ...
            try
            {
                ...
                if (ddlClassTypeSelection.SelectedItem.Text.Contains("Other"))
                {
                    ...
                    {
                        if (dal.InsertClassName(_classTitleOther.ToString().Replace("'", ""), 5, _weight))
                        {
                    ...
                    if (dal.UpdateClass(_userName, 5, seq, _classTitle, _gradeLevel, _weight, _credits, _collegeCode))
                    {
                        classSaved = true;
                    }
                    else
            ...
            catch (Exception)
            {
                if (ddlClassTypeSelection.SelectedItem.Text.Contains("Other"))
                {
                    ...
                    if (dal.InsertClass(_userName, 5, seq, _classTitle, _gradeLevel, _weight, _credits, _collegeCode))
                    {
                        classSaved = true;
                    }
                    else
                ...
                {
                    if (_classTitle != 11604 && _classTitle != 11605 && _classTitle != 11606)
                    {
                        if (dal.InsertClass(_userName, 5, seq, _classTitle, _gradeLevel, _weight, _credits, _collegeCode))
                        {
                            classSaved = true;
            ...
            try
            {
                if (ddl1Grade1.Text != "0")
                {
                    ...
                    if (dal.UpdateGrade(_userName, 5, seq, 1, _grade1))
                    {
                        grade1Saved = true;
                    }
                    else
                ...
                else if (dal.DeleteGrade(_userName, 5, seq, 1))
                {
                    grade1Saved = true;
                }
            }
            ...
            {
                if (dal.InsertGrade(_userName, 5, seq, 1, _grade1))
                {
                    grade1Saved = true;
                }
                else
            ...
            try
            {
                if (ddl1Grade2.Text != "0")
                {
                    ...
                    if (dal.UpdateGrade(_userName, 5, seq, 2, _grade2))
                    {
                        grade2Saved = true;
                    }
                    else
                ...
                else if (dal.DeleteGrade(_userName, 5, seq, 2))
                {
                    grade2Saved = true;
                }
            }
            ...
            {
                if (dal.InsertGrade(_userName, 5, seq, 2, _grade2))
                {
                    grade2Saved = true;
                }
                else
            ...
            try
            {
                if (ddl1Grade3.Text != "0")
                {
                    ...
                    if (dal.UpdateGrade(_userName, 5, seq, 3, _grade3))
                    {
                        grade3Saved = true;
                    }
                    else
                ...
                else if (dal.DeleteGrade(_userName, 5, seq, 3))
                {
                    grade3Saved = true;
                }
            }
            ...
            {
                if (dal.InsertGrade(_userName, 5, seq, 3, _grade3))
                {
                    grade3Saved = true;
                }
                else
            ...
            try
            {
                if (ddl1Grade4.Text != "0")
                {
                    ...
                    if (dal.UpdateGrade(_userName, 5, seq, 4, _grade4))
                    {
                        grade4Saved = true;
                    }
                    else
                ...
                else if (dal.DeleteGrade(_userName, 5, seq, 4))
                {
                    grade4Saved = true;
                }
            }
            ...
            {
                if (dal.InsertGrade(_userName, 5, seq, 4, _grade4))
                {
                    grade4Saved = true;
                }
                else
            ...
            try
            {
                if (ddl1Grade5.Text != "0")
                {
                    ...
                    if (dal.UpdateGrade(_userName, 5, seq, 5, _grade5))
                    {
                        grade5Saved = true;
                    }
                    else
                ...
                else if (dal.DeleteGrade(_userName, 5, seq, 5))
                {
                    grade5Saved = true;
                }
            }
            ...
            {
                if (dal.InsertGrade(_userName, 5, seq, 5, _grade5))
                {
                    grade5Saved = true;
                }
                else
            ...
            try
            {
                if (ddl1Grade6.Text != "0")
                {
                    ...
                    if (dal.UpdateGrade(_userName, 5, seq, 6, _grade6))
                    {
                        grade6Saved = true;
                    }
                    else
                ...
                else if (dal.DeleteGrade(_userName, 5, seq, 6))
                {
                    grade6Saved = true;
                }
            }
            ...
            {
                if (dal.InsertGrade(_userName, 5, seq, 6, _grade6))
                {
                    grade6Saved = true;
                }
                else
        ...
        {
            bool validated = true;
            if ((ddlClassTypeSelection.Text == "11604" || ddlClassTypeSelection.Text == "11605" || ddlClassTypeSelection.Text == "11606") && !nextPage)
            {
                vaClassList.Enabled = true;
                vaClassList.IsValid = false;
                validated = false;
            }
            else if ((ddlClassTypeSelection.Text == "11604" || ddlClassTypeSelection.Text == "11605" || ddlClassTypeSelection.Text == "11606") && nextPage && (ddlGradeLevel.Text != "" || tbCredits.Text != ""))
            {
                vaClassList.Enabled = true;
                vaClassList.IsValid = false;
                validated = false;
            ...
            if (((ddlClassTypeSelection.Text == "11589" || ddlClassTypeSelection.Text == "11590" || ddlClassTypeSelection.Text == "11591") && tbClassName.Text == "") && !nextPage)
            {
        ...
        {
            gData1 = dal.GetGrade(_userName, 5, seq, 1);
            gData2 = dal.GetGrade(_userName, 5, seq, 2);
            gData3 = dal.GetGrade(_userName, 5, seq, 3);
            gData4 = dal.GetGrade(_userName, 5, seq, 4);
            gData5 = dal.GetGrade(_userName, 5, seq, 5);
            gData6 = dal.GetGrade(_userName, 5, seq, 6);
            bool isValid = false;
            if (newData.ClassTitleCode == 11604 || newData.ClassTitleCode == 11605 || newData.ClassTitleCode == 11606)
            {
                isValid = false;
            }
        ...
        private bool ImplementSave()
        {
            ...
            if (SaveAndReturn(Convert.ToInt32(lblClass.Text.Remove(0, 15))))
            {
                string curClass = lblClass.Text.Remove(0, 15);
                ...
                if ((Convert.ToInt32(curClass) + 1) < 6)
                {
        ...
        private void RetrieveNextClass(int seq)
        {
            ...
            _seq = seq;
            Session["Sequence"] = _seq;
            cData = dal.GetClass(_userName, 5, _seq);
            gData1 = dal.GetGrade(_userName, 5, _seq, 1);
            gData2 = dal.GetGrade(_userName, 5, _seq, 2);
            gData3 = dal.GetGrade(_userName, 5, _seq, 3);
            gData4 = dal.GetGrade(_userName, 5, _seq, 4);
            gData5 = dal.GetGrade(_userName, 5, _seq, 5);
            gData6 = dal.GetGrade(_userName, 5, _seq, 6);
            if (cData != null)
            {
        ...
        {
            dal.DeleteClass(_userName, 5, seq);
            dal.DeleteAllGrades(_userName, 5, seq);
        }

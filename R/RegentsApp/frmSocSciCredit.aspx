<%@ Page Language="C#" MasterPageFile="~/Regents.Master" AutoEventWireup="true" CodeBehind="frmSocSciCredit.aspx.cs"
    Inherits="RegentsApp.SocSciCredit" Title="Regents' Application :: Social Science Credits"
    MaintainScrollPositionOnPostback="true" %>

<asp:Content ID="SocialScienceContent" ContentPlaceHolderID="regentsPlaceHolder"
    runat="server">
    <asp:UpdatePanel ID="up_SocSci" runat="server">
        <ContentTemplate>
            ...
            <script runat="server">
                ...
                {
                    SaveAndReturn(Convert.ToInt32(lblClass.Text.Remove(0, 21)));
            ...
            <script language="javascript" type="text/javascript">
                ...
                window.onload=function() {
                    if (document.getElementById('<%= ddlClassTypeSelection.ClientID %>').value == "11586" || document.getElementById('<%= ddlClassTypeSelection.ClientID %>').value == "11587" || document.getElementById('<%= ddlClassTypeSelection.ClientID %>').value == "11588") {
            ...
            <h1 style="font-family: Verdana;">
                Educational Information - Page 3
            </h1>
            <div style="font-family: Verdana; width: 600px; margin-left: auto; margin-right: auto;">
                ...
                <table>
                    <tr>
                        <td style="border-color: Black; border-style: solid; border-width: thin; width: 450px;
                            ...
                            <h3>
                                Social Science - 3.5 Credits Required</h3>
                        </td>
                    </tr>
                </table>
                <p>
                    Enter the Social Science courses you have taken, are taking, or will take in grades
                    ...
                    requirement has been entered for Social Science.</p>
                <asp:SqlDataSource ID="dsStandardCourse" runat="server" ConnectionString="<%$ ConnectionStrings:RegentsAppConnectionString %>"
                    ...
                    <SelectParameters>
                        <asp:Parameter DefaultValue="4" Name="ClassTypeCode" Type="Int32" />
                ...
                <div id="divClass" style="border: solid 1px black;" runat="server">
                    <br />
                    <asp:Label ID="lblClass" runat="server" Text="Social Science Class 1" Font-Bold="True"
                ...
                <asp:Label ID="lblCounter" runat="server" Text="   of 3.5 Social Science Credits Entered"></asp:Label>
                <br />
                <br />
                <asp:Button ID="btnNextPage" runat="server" Text="Science Section" OnClick="btnNextPage_Click"

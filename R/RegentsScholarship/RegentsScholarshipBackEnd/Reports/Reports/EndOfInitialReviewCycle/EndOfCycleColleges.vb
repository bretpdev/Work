...
Public Class EndOfCycleColleges
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RegentsScholarshipBackEnd.EndOfCycleColleges.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEndOfCycleColleges
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EndOfCycleColleges = New EndOfCycleColleges
        rpt.Site = Me.Site
        Return rpt
    End Function

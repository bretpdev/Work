...
Public Class FinalWeeklyAppeals
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RegentsScholarshipBackEnd.FinalWeeklyAppeals.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFinalWeeklyAppeals
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FinalWeeklyAppeals = New FinalWeeklyAppeals
        rpt.Site = Me.Site
        Return rpt
    End Function

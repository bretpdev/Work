...
Public Class FinalWeeklyApps
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RegentsScholarshipBackEnd.FinalWeeklyApps.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFinalWeeklyApps
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FinalWeeklyApps = New FinalWeeklyApps
        rpt.Site = Me.Site
        Return rpt
    End Function

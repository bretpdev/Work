...
Public Class FinalWeeklyDeferments
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "FinalWeeklyDeferments.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RegentsScholarshipBackEnd.FinalWeeklyDeferments.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFinalWeeklyDeferments
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FinalWeeklyDeferments = New FinalWeeklyDeferments
        rpt.Site = Me.Site
        Return rpt
    End Function

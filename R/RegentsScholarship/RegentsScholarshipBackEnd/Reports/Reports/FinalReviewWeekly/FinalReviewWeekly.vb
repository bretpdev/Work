...
Public Class FinalReviewWeekly
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RegentsScholarshipBackEnd.FinalReviewWeekly.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFinalReviewWeekly
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FinalReviewWeekly = New FinalReviewWeekly
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class DeniedPayments
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RegentsScholarshipBackEnd.DeniedPayments.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDeniedPayments
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DeniedPayments = New DeniedPayments
        rpt.Site = Me.Site
        Return rpt
    End Function

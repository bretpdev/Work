...
Public Class PrelimPayments
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RegentsScholarshipBackEnd.PrelimPayments.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPrelimPayments
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PrelimPayments = New PrelimPayments
        rpt.Site = Me.Site
        Return rpt
    End Function

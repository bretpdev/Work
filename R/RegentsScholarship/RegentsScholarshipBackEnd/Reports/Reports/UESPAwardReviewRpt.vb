...
Public Class UESPAwardReviewRpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RegentsScholarshipBackEnd.UESPAwardReviewRpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedUESPAwardReviewRpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As UESPAwardReviewRpt = New UESPAwardReviewRpt
        rpt.Site = Me.Site
        Return rpt
    End Function

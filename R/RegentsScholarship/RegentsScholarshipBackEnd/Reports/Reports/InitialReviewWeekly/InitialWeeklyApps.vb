...
Public Class InitialWeeklyApps
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RegentsScholarshipBackEnd.InitialWeeklyApps.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInitialWeeklyApps
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InitialWeeklyApps = New InitialWeeklyApps
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class InitialWeeklyUesp
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RegentsScholarshipBackEnd.InitialWeeklyUesp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInitialWeeklyUesp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InitialWeeklyUesp = New InitialWeeklyUesp
        rpt.Site = Me.Site
        Return rpt
    End Function

namespace RTRNMAIL
{
	partial class frmReturnMail
	{
		...
		private void InitializeComponent()
		{
			...
			// groupBox1
			// 
			this.groupBox1.Controls.Add(this.btnWhoAmI);
			...
			// btnWhoAmI
			// 
			this.btnWhoAmI.Location = new System.Drawing.Point(239, 32);
			this.btnWhoAmI.Name = "btnWhoAmI";
			this.btnWhoAmI.Size = new System.Drawing.Size(75, 23);
			this.btnWhoAmI.TabIndex = 2;
			this.btnWhoAmI.TabStop = false;
			...
			// txtBorrowerId
			// 
			this.txtBorrowerId.Location = new System.Drawing.Point(6, 34);
			this.txtBorrowerId.Name = "txtBorrowerId";
			this.txtBorrowerId.Size = new System.Drawing.Size(227, 20);
			...
			this.label1.Text = "ACS Encryption Code / SSN / Account Number / Reference ID";
			// 
			// btnEnter
			// 
			this.btnEnter.DialogResult = System.Windows.Forms.DialogResult.OK;
			this.btnEnter.Location = new System.Drawing.Point(54, 89);
			...
			this.btnCancel.Location = new System.Drawing.Point(198, 89);
			...
			this.Name = "frmReturnMail";
			this.Text = "Return Mail Script";

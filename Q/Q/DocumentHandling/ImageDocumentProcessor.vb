...
#Region " API "
    ...
    Public Sub ProcessEntireFile()
        ...
        If (File.Exists(_recoveryFilePathAndName)) Then
            ...
            Using sr As New StreamR(_recoveryFilePathAndName)
                rSSN = sr.ReadLine()
            End Using
        End If
        'do processing
...
#Region " Inner Workings "
    ...
    Private Sub InitializeComponents()
        ...
        'Word.Visible = False
        'open form doc
        _word.Documents.Open(FileName:=_docPath & _doc & ".doc", ConfirmConversions:=False,
        ...
        _word.ActiveDocument.MailMerge.OpenDataSource(Name:=_dataFile,
        ...
        _word.ActiveDocument.SaveAs(FileName:=DataAccessBase.PersonalDataDirectory & _doc & ".doc",
    ...
    Private Function ImageRecord(ByVal lastSSNSuccessfullyProcessed As String) As String
        ...
        Else
            ...
            Else
                ...
                'save the file
                _word.ActiveDocument.SaveAs(FileName:="\\imgprodkofax\\ascent$\UT" & _archLib & "Other_imp\" & ssn & "_" & timeStamp & ".doc",
                    FileFormat:=WdSaveFormat.wdFormatDocument, LockComments:=False, Password:="", AddToRecentFiles:=
                    True, WritePassword:="", ReadOnlyRecommended:=False, EmbedTrueTypeFonts:=
                    False, SaveNativePictureFormat:=False, SaveFormsData:=False,
                    SaveAsAOCELetter:=False)
                ...
                If _doInternalRecovery Then
                    'update recovery log
                    _recoveryFileHandle = FreeFile()
                    Using sw As New StreamW(_recoveryFilePathAndName)
                        sw.WriteLine(ssn)
                    End Using
                End If
    ...
    Private Sub DisposeOfComponents()
        ...
        If (File.Exists(_recoveryFilePathAndName)) Then FS.Delete(_recoveryFilePathAndName)
    End Sub

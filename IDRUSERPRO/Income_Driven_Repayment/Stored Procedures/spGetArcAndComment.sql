...
BEGIN
	...
	SELECT 
		...
		ALD.co_borr_arc AS CoBorrowerArc,
		ALD.co_borr_system_comment AS CoBorrowerComment
	FROM 
	...
	LEFT JOIN Arc_Letter_Mapping ALM
		ON ALM.repayment_type_id = RT.repayment_type_id --Mapping by repayment_type_id should only be present for Income_Driven_Repayment and not IncomeBasedRepaymentUheaa

USE CLS
GO
DECLARE @LineData VARCHAR(MAX) = 'ACH Stopped'
...
FROM
	...
	INNER JOIN CDW..LN83_EFT_TO_LON History
		ON History.BF_SSN = PD10.DF_PRS_ID
		AND History.LC_STA_LN83 = 'D'
		AND CAST(History.LD_EFT_EFF_END AS DATE) BETWEEN @PREVIOUSWORKDAY AND @YESTERDAY
	INNER JOIN CDW..BR30_BR_EFT BR30_History
		ON BR30_History.BF_SSN = History.BF_SSN
		AND BR30_History.BN_EFT_SEQ = History.BN_EFT_SEQ
		AND BR30_History.BC_EFT_STA != 'A'
	...
	LEFT JOIN CDW..BR30_BR_EFT BR30
...
FROM
	...
	INNER JOIN CDW..BR30_BR_EFT BR30_History
		ON BR30_History.BF_SSN = History.BF_SSN
		AND BR30_History.BN_EFT_SEQ = History.BN_EFT_SEQ
		AND LTRIM(RTRIM(BR30_History.BF_DDT_PAY_EDS)) = PD10E.DF_PRS_ID

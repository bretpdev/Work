USE CLS
GO
DECLARE @LineData VARCHAR(MAX) = 'Name Change'
...
FROM
	...
	(
		SELECT
			...
			PD11.DM_PRS_MID_HST,
			PD11.DM_PRS_LST_HST,
			PD11.DM_PRS_LST_SFX_HST,
			PD11.DD_CRT_PD11
		FROM
			CDW..PD11_PRS_NME_HST PD11
		WHERE
			CAST(PD11.DD_CRT_PD11 AS DATE) BETWEEN @PREVIOUSWORKDAY AND @YESTERDAY
			AND PD11.DF_PRS_ID NOT LIKE 'P%'
	) PD11

USE CLS
GO
DECLARE @LineData VARCHAR(MAX) = 'Phone Number Change'
...
FROM
	...
	(
		...
		AND
		(
			PD41.DN_DOM_PHN_ARA_HST != PD40.DN_DOM_PHN_ARA
			OR PD41.DN_DOM_PHN_XCH_HST != PD40.DN_DOM_PHN_XCH
			OR PD41.DN_DOM_PHN_LCL_HST != PD40.DN_DOM_PHN_LCL
			OR PD41.DN_PHN_XTN_HST != PD40.DN_PHN_XTN
			OR PD41.DN_FGN_PHN_INL_HST != PD40.DN_FGN_PHN_INL
			OR PD41.DN_FGN_PHN_CNY_HST != PD40.DN_FGN_PHN_CNY
			OR PD41.DN_FGN_PHN_CT_HST != PD40.DN_FGN_PHN_CT
			OR PD41.DN_FGN_PHN_LCL_HST != PD40.DN_FGN_PHN_LCL
		)
...
WHERE
	...
	AND CAST(PD40.DF_LST_DTS_PD40 AS DATE) BETWEEN @PREVIOUSWORKDAY AND @YESTERDAY
...
FROM
	...
	INNER JOIN CDW..PD40_PRS_PHN PD40
		ON PD10E.DF_PRS_ID = PD40.DF_PRS_ID
	INNER JOIN
	(
		SELECT
			PD41.DF_PRS_ID,

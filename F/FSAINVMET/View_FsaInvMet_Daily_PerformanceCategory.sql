...
/****** Object:  View [FsaInvMet].[Daily_PerformanceCategory]    Script Date: 11/5/2019 1:31:03 PM ******/
SET ANSI_NULLS ON
GO
			...
			CASE
				WHEN BD.ORD = 0 THEN
					CASE
						...
						WHEN BD.WC_DW_LON_STA = '05' AND BD.CR_5505 = 1 THEN '13' --New admin forb logic for COVID 19
						WHEN BD.WC_DW_LON_STA = '02' AND BD.LN_DLQ_MAX < 1 THEN '01'
						WHEN BD.WC_DW_LON_STA = '23' AND LN10.IC_LON_PGM NOT IN('DLPLUS') THEN '01'
						WHEN BD.WC_DW_LON_STA = '23' AND LN10.IC_LON_PGM IN('DLPLUS') THEN '02'

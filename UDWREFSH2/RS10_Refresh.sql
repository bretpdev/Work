...
MERGE 
	...
	WHEN MATCHED THEN 
		UPDATE SET 
			...
			RS10.LC_RPY_DIS_PRT_PGH = L.LC_RPY_DIS_PRT_PGH,
			RS10.LC_NSI_RAL_OTH_CAT = L.LC_NSI_RAL_OTH_CAT
	WHEN NOT MATCHED THEN
		...
		(
			...
			L.LC_RPY_DIS_PRT_PGH,
			L.LC_NSI_RAL_OTH_CAT
		)

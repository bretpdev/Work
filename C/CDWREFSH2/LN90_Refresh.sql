...
DECLARE @LastRefreshStatusDate VARCHAR(30) = (SELECT CONVERT(VARCHAR(30), ISNULL(DATEADD(HOUR,-3,CAST(MAX(LN90.LD_STA_LON90) AS DATETIME)), '1-1-1900 00:00:00'), 21) FROM LN90_FIN_ATY LN90)
...
FOR READ ONLY WITH UR
	...
	WHEN MATCHED THEN 
		UPDATE SET 
			...
			LN90.LA_GOV_INT_100_PER = L.LA_GOV_INT_100_PER,
			LN90.LA_RPA_CTH_FAT_ADJ = L.LA_RPA_CTH_FAT_ADJ,
			LN90.LA_FAT_NSI_CAP = L.LA_FAT_NSI_CAP,
			LN90.LA_FAT_NSI_NCA = L.LA_FAT_NSI_NCA,
			LN90.LA_FAT_NSI_NAM = L.LA_FAT_NSI_NAM,
			LN90.LA_FAT_NSI_ACR_CAP = L.LA_FAT_NSI_ACR_CAP,
			LN90.LA_FAT_NSI_ACR_NCA = L.LA_FAT_NSI_ACR_NCA,
			LN90.LA_FAT_NSI_ACR_NAM = L.LA_FAT_NSI_ACR_NAM
	WHEN NOT MATCHED THEN
		...
		(
			...
			L.LA_FAT_DL_REB,
			L.LA_GOV_INT_100_PER,
			L.LA_RPA_CTH_FAT_ADJ,
			L.LA_FAT_NSI_CAP,
			L.LA_FAT_NSI_NCA,
			L.LA_FAT_NSI_NAM,
			L.LA_FAT_NSI_ACR_CAP,
			L.LA_FAT_NSI_ACR_NCA,
			L.LA_FAT_NSI_ACR_NAM
		)

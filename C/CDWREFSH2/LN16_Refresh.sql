...
ELSE IF @CountDifference != 0 AND @LoopCount = 0
	BEGIN
		...
		PRINT 'The local record count for some SSNs do not match the remote warehouse count.  Deleting all local LN16 records for these borrowers and fullying refreshing from the remote warehouse.'

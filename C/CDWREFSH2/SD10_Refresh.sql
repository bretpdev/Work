DECLARE
	@TableName VARCHAR(50) = 'SD10_STU_SPR',
	...
	'
	PRINT '@GetCountDifferenceQuery: ' + @GetCountDifferenceQuery
		...
		BEGIN
			...
			'
				...
				FROM
					' + @LocalTableName + ' LOCAL
				WHERE
					LOCAL.LF_STU_SSN IN (' + REPLACE(@Ssns, '''', '') + ')
			'
			PRINT '@DeleteBadQuery: ' + @DeleteBadQuery

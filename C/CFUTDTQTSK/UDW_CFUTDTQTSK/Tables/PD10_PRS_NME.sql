CREATE TABLE [dbo].[PD10_PRS_NME] (
    ...
    CONSTRAINT [PK_PD10_PRS_NME_1] PRIMARY KEY CLUSTERED ([DF_PRS_ID] ASC) WITH (FILLFACTOR = 95)
);
...
GO
CREATE NONCLUSTERED INDEX [IX_DF_SPE_ACC_ID]
    ON [dbo].[PD10_PRS_NME]([DF_SPE_ACC_ID] ASC) WITH (FILLFACTOR = 95);


GO
CREATE NONCLUSTERED INDEX [IX_DF_PRS_ID]
    ON [dbo].[PD10_PRS_NME]([DF_PRS_ID] ASC)
    INCLUDE([DM_PRS_1], [DM_PRS_LST]) WITH (FILLFACTOR = 95);

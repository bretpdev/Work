...
BEGIN
	...
	SELECT COALESCE(Instructions, '') AS Instructions 
	FROM LTDB_DAT_CentralPrintingDocData WHERE ID = @letterId

END
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spGetCostCenterInstructions] TO [db_executor]
    AS [dbo];

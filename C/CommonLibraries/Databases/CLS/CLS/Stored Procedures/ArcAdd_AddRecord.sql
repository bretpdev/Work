...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[ArcAdd_AddRecord] TO [db_executor]
    AS [dbo];

GO
GRANT EXECUTE
    ON OBJECT::[dbo].[ArcAdd_AddRecord] TO [UHEAA\SystemAnalysts]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[ArcAdd_AddRecord] TO [UHEAA\CornerStoneUsers]
    AS [dbo];

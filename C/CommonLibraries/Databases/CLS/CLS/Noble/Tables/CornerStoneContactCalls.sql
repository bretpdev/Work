CREATE TABLE [Noble].[CornerStoneContactCalls] (
    [CornerStoneContactCallsId] INT           IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK__CornerSt__EC9D475A03BC5979] PRIMARY KEY CLUSTERED ([CornerStoneContactCallsId] ASC)
);

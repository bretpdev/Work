CREATE TABLE [dbo].[BL10_Bill] (
    ...
    [LA_INT_PD_LST_STM] NUMERIC(8, 2) NULL, 
    [LA_FEE_PD_LST_STM] NUMERIC(8, 2) NULL, 
    [LA_PRI_PD_LST_STM] NUMERIC(8, 2) NULL, 
    [LA_TTL_PD_LST_STM] NUMERIC(8, 2) NULL, 
    [LA_LTE_FEE_OTS_PRT] NUMERIC(8, 2) NULL, 

CREATE PROCEDURE [dbo].[LT_TS06BRATE_Loans]
...
BEGIN
	...
	SELECT
		...
		LN72.LD_ITR_EFF_BEG AS [Interest Rate Effective Date]
	FROM
		LN10_Loan LN10
...
IF @@ROWCOUNT = 0 
	BEGIN
		RAISERROR('No data returned. ([dbo].[LT_TS06BRATE_Loans])',11,2)
	END

GO
GRANT EXECUTE
    ON OBJECT::[dbo].[LT_TS06BRATE_Loans] TO [db_executor]
    AS [dbo];

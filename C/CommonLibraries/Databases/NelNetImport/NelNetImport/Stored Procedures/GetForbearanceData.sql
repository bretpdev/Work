...
AS
    SELECT 
        ...
        DBO.CONVERT_DATE([f1_start_date]) AS LD_FOR_REQ_BEG,
        DBO.CONVERT_DATE([f1_end_date]) AS LD_FOR_REQ_END,
        '' AS LF_FOR_CTL_NUM, 
        ...
        DBO.CONVERT_DATE([f1_start_date]) AS LD_FOR_BEG,
        DBO.CONVERT_DATE([f1_end_date]) AS LD_FOR_END,
        '' AS LD_FOR_APL, 
        CASE    
            WHEN [f1_type_of_defer_forb] = 'FA9' THEN [f1_low_payment_amount]
            ELSE '' 
        ...
        DBO.CONVERT_DATE([f1_start_date]) AS LD_FOR_BR_REQ_BEG,
        DBO.CONVERT_DATE([f1_end_date]) AS LD_FOR_BR_REQ_END,
    ...
    WHERE 
        ...
        AND [f1_type_of_defer_forb] IN ('FA0','FA4','FA6','FAF','FAD',
                                        ...
                                        'FRO','FSD','FTF','FV1','FW1')
    ORDER BY
        DBO.CONVERT_DATE([f1_start_date]),

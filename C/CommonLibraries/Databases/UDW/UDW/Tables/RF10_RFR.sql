CREATE TABLE [dbo].[RF10_RFR] (
    ...
    [BD_EFF_RFR]         DATETIME    NULL,
    [BF_RFR]             VARCHAR (9) NULL,
    [BC_RFR_TYP]         CHAR (1)    NULL,
    [BF_LST_DTS_RF10]    DATETIME    NULL,
    [BD_EFF_RFR_HST]     DATETIME    NULL,
    [BC_REA_RFR_HST]     CHAR (1)    NULL,
    [BF_LST_USR_HST_RFR] VARCHAR (8) NULL,
    [BD_ATH_3_PTY_END]   DATETIME    NULL,
    CONSTRAINT [PK__RF10_RFR__8FA23B134AA30C57] PRIMARY KEY CLUSTERED ([BF_SSN] ASC, [BN_SEQ_RFR] ASC) WITH (FILLFACTOR = 95)
);
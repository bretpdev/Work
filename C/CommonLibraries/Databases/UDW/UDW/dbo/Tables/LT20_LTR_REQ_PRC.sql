...
GO
CREATE NONCLUSTERED INDEX [CIX_RM_DSC_LTR_PRC_RI_LTR_REQ_DEL_PRC]
    ON [dbo].[LT20_LTR_REQ_PRC]([RM_DSC_LTR_PRC] ASC, [RI_LTR_REQ_DEL_PRC] ASC, [PrintedAt] ASC, [InactivatedAt] ASC)
    INCLUDE([DF_SPE_ACC_ID], [RM_APL_PGM_PRC], [RT_RUN_SRT_DTS_PRC], [RN_SEQ_LTR_CRT_PRC], [RN_SEQ_REC_PRC], [RF_SBJ_PRC]) WITH (FILLFACTOR = 95);


GO
CREATE NONCLUSTERED INDEX [CIX_DF_SPE_ACC_ID_RM_APL_PGM_PRC_RT_RUN_SRT_DTS_PRC]
    ON [dbo].[LT20_LTR_REQ_PRC]([DF_SPE_ACC_ID] ASC, [RM_APL_PGM_PRC] ASC, [RT_RUN_SRT_DTS_PRC] ASC, [RN_SEQ_LTR_CRT_PRC] ASC, [PrintedAt] ASC, [InactivatedAt] ASC) WITH (FILLFACTOR = 95);

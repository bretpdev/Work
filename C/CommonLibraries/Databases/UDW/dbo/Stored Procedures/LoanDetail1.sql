...
CREATE PROCEDURE [dbo].[LoanDetail1]
	@LetterId varchar(10),
	@BF_SSN  CHAR(9)
AS
			...
			(
				...
				FROM
					...
					(
						...
						ON LN80_MAX_CRT_DTE.BF_SSN = LN80.BF_SSN
						AND LN80_MAX_CRT_DTE.LN_SEQ = LN80.LN_SEQ
						AND LN80_MAX_CRT_DTE.MAX_LD_BIL_CRT = LN80.LD_BIL_CRT
				WHERE
					LN80.LC_STA_LON80 = 'A'
				GROUP BY
					LN80.BF_SSN,
					...
					AND LN80_MAX.LD_BIL_CRT = LN80.LD_BIL_CRT

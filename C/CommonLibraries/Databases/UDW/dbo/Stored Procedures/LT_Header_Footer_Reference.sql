...
AS
	...
	SELECT
		...
		LTRIM(RTRIM(REPLACE(PD30.DX_STR_ADR_1, ',', ' '))) AS Address1,
		LTRIM(RTRIM(REPLACE(PD30.DX_STR_ADR_2, ',', ' '))) AS Address2,
		RTRIM(PD30.DM_FGN_CNY) as Country,
		PD10.DF_PRS_ID AS AccountNumber,

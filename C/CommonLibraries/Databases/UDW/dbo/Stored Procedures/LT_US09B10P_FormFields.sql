...
SELECT DISTINCT
	CASE 
		WHEN SUM((ISNULL(LN80.LN_LTE_FEE, 0.00) + ISNULL(LN80.LA_BIL_PAS_DU, 0.00))) != 0 THEN '$' + (CONVERT(VARCHAR(15), SUM((ISNULL(LN80.LN_LTE_FEE, 0.00) + ISNULL(LN80.LA_BIL_PAS_DU, 0.00))), 1))

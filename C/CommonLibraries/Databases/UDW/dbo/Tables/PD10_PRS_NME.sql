CREATE TABLE [dbo].[PD10_PRS_NME] (
    ...
    CONSTRAINT [PK_PD10_PRS_NME] PRIMARY KEY CLUSTERED ([DF_PRS_ID] ASC) WITH (FILLFACTOR = 95)
);
...
CREATE NONCLUSTERED INDEX [IX_DFPRSID]
    ...
    INCLUDE([DF_SPE_ACC_ID]) WITH (FILLFACTOR = 95);


GO
CREATE NONCLUSTERED INDEX [IX_DF_SPE_ACC_ID_DF_PRS_ID]

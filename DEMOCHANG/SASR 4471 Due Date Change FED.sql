USE CLS
GO
DECLARE @LineData VARCHAR(MAX) = 'Due Date Changed'
...
FROM
	...
	INNER JOIN CDW..RS10_BR_RPD History
		ON History.BF_SSN = RS10.BF_SSN
		AND History.LC_STA_RPST10 = 'I'
		AND DAY(History.LD_RPS_1_PAY_DU) != DAY(RS10.LD_RPS_1_PAY_DU)
		AND CAST(History.LD_STA_RPST10 AS DATE) BETWEEN @PREVIOUSWORKDAY AND @YESTERDAY

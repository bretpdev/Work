/*UTLWD03 - FEDERAL DIRECT CONSOLIDATION RECOVERIES*/

/*LIBNAME DLGSUTWH DB2 DATABASE=DLGSUTWH OWNER=OLWHRM1;
%LET RPTLIB = %SYSGET(reportdir);
FILENAME REPORT2 "&RPTLIB/ULWD03.LWD03R2";*/
...
FROM CONNECTION TO DB2 (
	...
	INNER JOIN 
		...
		WHERE PF_ACT = 'DCONS'
		AND BX_CMT LIKE '%FEDERAL DIRECT%'
...
PROC REPORT DATA=DCONS NOWD SPACING=2 HEADSKIP SPLIT='~';
TITLE 'FEDERAL DIRECT CONSOLIDATION RECOVERIES';
TITLE2 "RUN DATE:  &RUNDATE";
FOOTNOTE  'JOB = UTLWD03     REPORT = ULWD03.LWD03R2';

...
CallableStatement spGetTopic = ConnspGetTopic.prepareCall("{?= call dbo.spLCTR_getRiskPolicy(?,?)}");
Object spGetTopic_data;
spGetTopic.registerOutParameter(1,Types.LONGVARCHAR);
spGetTopic.setString(2,request.getParameter("ID").toString());
spGetTopic.setString(3,request.getParameter("type").toString());
spGetTopic.execute();

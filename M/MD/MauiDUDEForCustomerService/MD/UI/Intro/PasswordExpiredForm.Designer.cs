namespace MD
{
    partial class PasswordExpiredForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.LengthCheck = new MD.ReadOnlyCheckbox();
            this.UppercaseCheck = new MD.ReadOnlyCheckbox();
            this.LowerCaseCheck = new MD.ReadOnlyCheckbox();
            this.NumberCheck = new MD.ReadOnlyCheckbox();
            this.PreviousCheck = new MD.ReadOnlyCheckbox();

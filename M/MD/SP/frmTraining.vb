...
#End Region
    Public Overloads Function Show() As Boolean
        Me.ShowDialog()
    ...
    Sub RunPPT()
        'SP.frmKnarlyDUDE.KnarlyDude("To end the slide show early, press the Escape button.", "MauiDUDE")
        ...
        'Loop
        'If Dir("C:\Windows\Temp\tempPPT.ppt") <> "" Then
        '    oPres = oPresentations.Open("C:\Windows\Temp\tempPPT.ppt", True, True, False)
        'ElseIf Dir("T:\tempPPT.ppt") <> "" Then
        '    oPres = oPresentations.Open("T:\tempPPT.ppt", True, True, False)
        'End If
    ...
    Function CopyPPT(ByVal str As String) As Boolean
        Try
            File.Copy("X:\Training Modules\" & str, "T:\tempPPT.ppt", True)
            Return True

...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmKnarlyDUDE))
        ...
        Me.Name = "frmKnarlyDUDE"
        Me.Text = "frmKnarlyDUDE"
        Me.TopMost = True
...
#End Region
    ...
    Public Shared Sub KnarlyDude(ByVal Message As String, ByVal Title As String, Optional ByVal Center As Boolean = False)
        Dim KD As New frmKnarlyDUDE
        KD.lblMessage.Text = Message
        KD.Text = "Knarly Dude: " & Title
        If Center Then
            KD.lblMessage.TextAlign = ContentAlignment.MiddleCenter
        Else
            KD.lblMessage.TextAlign = ContentAlignment.MiddleLeft
        End If
        Beep()
        KD.ShowDialog()
    End Sub

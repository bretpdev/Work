	...
	USING
		(
			SELECT
				OQ.*,
				CASE 
					WHEN OQ.RM_DSC_LTR_PRC IN (''US10BTCUR'',''US10OTCUR1'',''US10OTCUR2'',''US10OTCUR3'',''US10OTCUR4'') THEN 0
				...
				(
					...
					''
						...
						FROM
							...
							INNER JOIN OLWHRM1.LT20_LTR_REQ_PRC LT20 ON LT20.RF_SBJ_PRC = PD10.DF_PRS_ID 

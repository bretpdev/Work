...
/****** Object:  View [UheInvMet].[Monthly_BorrowerLevel]    Script Date: 11/11/2019 3:15:32 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [UheInvMet].[Monthly_BorrowerLevel]
...
(
	...
	FROM
		[UheInvMet].[Monthly_LoanLevel] BD
		LEFT JOIN [UheInvMet].[Monthly_LoanLevel] PerfLoan 

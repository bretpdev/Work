...
INSERT INTO @PrintProcessing (AccountNumber, scriptFileId, SourceFile, ArcAddedAt, ImagedAt, EcorrDocumentCreatedAt, PrintedAt, CreatedBy, AddedAt, OnEcorr, DeletedAt, DeletedBy, BOR_CNT) --TODO:  uncomment for production

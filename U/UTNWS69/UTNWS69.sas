%LET REPORT_DATE = TODAY() - 2;
/*%LET RPTLIB = %SYSGET(reportdir);*/
%LET RPTLIB = T:\SAS;
FILENAME REPORTZ "&RPTLIB/UNWS69.NWS69RZ";
FILENAME REPORT2 "&RPTLIB/UNWS69.NWS69R2";
FILENAME REPORT3 "&RPTLIB/UNWS69.NWS69R3";
...
DATA TRUMP;
	...
	DATALINES;
		...
		6,06,IN CURE
		7,07,CLAIM PENDING
		8,08,CLAIM SUBMITTED
		9,09,CLAIM CANCELLED
		10,10,CLAIM REJECT
		11,11,CLAIM RETURNED
		12,12,CLAIM PAID
		13,13,PRE-CLAIM PENDING
		14,14,PRE-CLAIM SUBMITTED
		15,15,PRE-CLAIM CANCELLED
		16,16,DEATH ALLEGED
		17,17,DEATH VERIFIED
		18,18,DISABILITY ALLEGED
		19,19,DISABILITY VERIFIED
		20,20,BANKRUPTCY ALLEGED
		21,21,BANKRUPTCY VERIFIED
		22,22,PAID IN FULL
		23,23,NOT FULLY ORIGINATED
		24,88,PROCESSING ERROR
		25,98,UNKNOWN STATUS
;
			...
			CONNECTION TO DB2 
				(
					SELECT DISTINCT
						...
						,PD30.DI_VLD_ADR
						,CASE
							WHEN PD32.DF_PRS_ID IS NOT NULL THEN 'Y'
							ELSE 'N'
						END AS DI_VLD_ADR_EML
...
TITLE 		'Late Stage Delinquency - FED';
TITLE2		"RUNDATE &SYSDATE9";
FOOTNOTE1  	"THIS DOCUMENT MAY CONTAIN BORROWERS' SENSITIVE INFORMATION THAT UHEAA HAS PLEDGED TO PROTECT.";
FOOTNOTE2	'PLEASE TAKE APPROPRIATE PRECAUTIONS TO SAFEGUARD THIS INFORMATION.';
FOOTNOTE3	;
FOOTNOTE4   'JOB = UTNWS69  	 REPORT = UNWS69.NWS69R3';

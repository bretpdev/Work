/*UTLWE05 WAMU MONTHEND DATAFILE*/
...
/*FILENAME REPORT2 "&RPTLIB/ULWE05.LWE05R2";*/

LIBNAME  WORKLOCL  REMOTE  SERVER=CYPRUS  SLIBREF=WORK;
RSUBMIT;
PROC SQL;
CONNECT TO DB2 (DATABASE=DLGSUTWH);
CREATE TABLE WACUDF AS
SELECT *
...
PROC SORT DATA=WACUDF;
BY BF_SSN;
RUN;

DATA _NULL_;
SET  WORK.WACUDF;
FILE 'T:\SAS\ULWE05.LWE05R2' DELIMITER=',' DSD DROPOVER LRECL=32767;

...
/****** Object:  Table [FsaInvMet].[Monthly_LoanLevel]    Script Date: 11/11/2019 1:15:51 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER TABLE [FsaInvMet].[Monthly_LoanLevel] ADD CONSTRAINT [PK_Monthly_LoanLevel] PRIMARY KEY CLUSTERED
(
	[BF_SSN] ASC
      ,[LN_SEQ] ASC
);

...
namespace UHEAAOperationsTrackingSystems
{
    public class StringEncryption
    {
        ...
        private string _encryptionKey = "Bagong Pagsubaybay UHEAA's System ay ang bomba!"; //in phillipino
        ...
        public string Encrypt(string unencryptedString)
        {
            ...
            unencryptedString = unencryptedString.Replace("\0", string.Empty);
        ...
        public string Decrypt(string encryptedString)
        {
            ...
            try
            {
                ...
                using (MemoryStream memoryStream = new MemoryStream(encryptedBytes))
                {
                    ...
                    decryptedString = Encoding.ASCII.GetString(decryptedBytes).Replace("\0", string.Empty);
                    memoryStream.Close();
                }

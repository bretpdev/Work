...
Public Class rptCRUESPPayments
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Receipts.rptCRUESPPayments.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCRUESPPayments
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCRUESPPayments = New rptCRUESPPayments
        rpt.Site = Me.Site
        Return rpt
    End Function

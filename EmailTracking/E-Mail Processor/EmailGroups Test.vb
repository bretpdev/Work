...
Public Class EmailGroups_Test
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Eacker.EmailGroups Test.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEmailGroups_Test
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EmailGroups_Test = New EmailGroups_Test()
        rpt.Site = Me.Site
        Return rpt
    End Function

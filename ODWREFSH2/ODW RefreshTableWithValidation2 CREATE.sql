...
/****** Object:  StoredProcedure [dbo].[RefreshTableWithValidation2]    Script Date: 5/1/2020 11:51:46 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[RefreshTableWithValidation2]
...
BEGIN
	...
	END
	ELSE IF DB_NAME() IN ('UDW','ODW')
	BEGIN
		SET @ServerName = 'DUSTER'
		SET @RemoteSchema = 'OLWHRM1'	
	END
	ELSE
		RAISERROR('This procedure may only be run on UDW/ODW or CDW', 16, 11)

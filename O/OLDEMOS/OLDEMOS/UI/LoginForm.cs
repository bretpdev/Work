    ...
    public partial class LoginForm : BaseForm
    {
        ...
        public void Initialize()
        {
            ...
            if (quickMode)
            {
                ...
                this.Controls.Remove(CommonMenu1);
        ...
        private void SyncButtons()
        {
            ...
            LoginButton.Enabled = validLength && validId;
        }
        ...
        private void Login()
        {
            ...
            {
                if (Info.YesNo("Are you sure you want to log in to test mode?"))
                {
                    ModeHelper.TestMode();
                }
                else
            ...
            if (Helper.Login.Login(this, this))
            {
                this.Hide();
                if (!quickMode)
                {
                    var landing = Helper.UI.CreateForm<LandingForm>();
                    landing.Show();
                }
                this.Close();
            }

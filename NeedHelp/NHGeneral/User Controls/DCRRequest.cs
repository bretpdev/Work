...
namespace NHGeneral
{
    partial class DCRRequest : MiddleClassBetweenBaseAndControls
    {
        ...
        public DCRRequest(Ticket activeTicket, List<BusinessUnit> businessUnit, List<string> categoryList, List<string> subjectList, List<string> systemList, List<string> urgencyList, List<SqlUser> userList, bool hasAccess, ProcessLogRun logRun)
        {
            InitializeComponent();
            LogRun = logRun;
            ...
            List<string> subjects = new List<string>(subjectList);
            ...
            subjects.Insert(0, string.Empty);
            cboSubject.DataSource = subjects;
            cboSubject.SelectedItem = activeTicket.Data.TheTicketData.Subject.IsNullOrEmpty() ? null : subjects.Where(s => s.ToString().ToLower() == activeTicket.Data.TheTicketData.Subject.ToLower()).FirstOrDefault();
            ...
            if (TheTicket.Data.TheTicketData.AssignProgrammer)
                cbxProgrammer.Checked = true;
            ...
            if (!hasAccess)
            {
                lblNewCategory.Enabled = false;
                txtNewCategory.Enabled = false;
                cbxProgrammer.Enabled = false;
            }
            SetToolTips();
        }
        ...
        public override void BindNewTicket(Ticket activeTicket)
        {
            ...
            GetAttachedForms();
            txtNewCategory.Text = "";
            cboSubject.Text = activeTicket.Data.TheTicketData.Subject;
        }
        ...
        public override TicketData GetModifiedTicketData(Ticket activeTicket, List<SqlUser> userList, NotifyType.Type type)
        {
            ...
            theTicket.AssignProgrammer = cbxProgrammer.Checked;
            ...
            theTicket.Subject = cboSubject.Text;
            ...
            if (txtNewCategory.Text.Trim().IsPopulated())
            {
                theTicket.Subject = txtNewCategory.Text;
                theTicket.AssignProgrammer = cbxProgrammer.Checked;
            }
            return theTicket;
        }

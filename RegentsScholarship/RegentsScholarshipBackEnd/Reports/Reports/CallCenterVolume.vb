...
Public Class CallCenterVolume
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RegentsScholarshipBackEnd.CallCenterVolume.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCallCenterVolume
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CallCenterVolume = New CallCenterVolume
        rpt.Site = Me.Site
        Return rpt
    End Function

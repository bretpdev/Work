...
Public Class EndOfCycleAppeals
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RegentsScholarshipBackEnd.EndOfCycleAppeals.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEndOfCycleAppeals
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EndOfCycleAppeals = New EndOfCycleAppeals
        rpt.Site = Me.Site
        Return rpt
    End Function

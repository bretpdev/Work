...
Public Class EndOfCycleOutcomes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RegentsScholarshipBackEnd.EndOfCycleOutcomes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEndOfCycleOutcomes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EndOfCycleOutcomes = New EndOfCycleOutcomes
        rpt.Site = Me.Site
        Return rpt
    End Function

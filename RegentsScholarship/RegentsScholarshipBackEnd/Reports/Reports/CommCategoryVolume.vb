...
Public Class CommCategoryVolume
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RegentsScholarshipBackEnd.CommCategoryVolume.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCommCategoryVolume
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CommCategoryVolume = New CommCategoryVolume
        rpt.Site = Me.Site
        Return rpt
    End Function

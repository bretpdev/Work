...
Public Class FinalWeeklyStages
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RegentsScholarshipBackEnd.FinalWeeklyStages.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFinalWeeklyStages
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FinalWeeklyStages = New FinalWeeklyStages
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class PaymentsNotRenewed
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RegentsScholarshipBackEnd.PaymentsNotRenewed.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPaymentsNotRenewed
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PaymentsNotRenewed = New PaymentsNotRenewed
        rpt.Site = Me.Site
        Return rpt
    End Function

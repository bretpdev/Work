...
DECLARE @EmailCampaign VARCHAR(20) = 'DE40IDRFED.html' --Letter Id For Email Campaigns Table
DECLARE @SasId VARCHAR(20) = '40DELEMFD'
...
WHERE
	...
	AND DW01.WC_DW_LON_STA IN ('03') -- in repayment
	AND 
	(
	...
	(
		(
			@DateName = 'Monday'
			AND LN16.LN_DLQ_MAX + 1 BETWEEN  40 and 42
			AND LN16.LC_STA_LON16 = 1
		)
		OR
		(
			@DateName != 'Monday' --It is not necessary, but it is more clear
			AND LN16.LN_DLQ_MAX + 1 = 40
			AND LN16.LC_STA_LON16 = 1
		)
	)

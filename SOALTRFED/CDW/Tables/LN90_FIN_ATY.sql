...
GO
CREATE NONCLUSTERED INDEX [IX_LCSTALON90_PCFATTYP]
    ON [dbo].[LN90_FIN_ATY]([LC_STA_LON90] ASC, [PC_FAT_TYP] ASC)
    INCLUDE([BF_SSN], [LN_SEQ]);


GO
CREATE NONCLUSTERED INDEX [IX_LCFATREVREA_LCSTALON90_PCFATTYP]
    ON [dbo].[LN90_FIN_ATY]([LC_FAT_REV_REA] ASC, [LC_STA_LON90] ASC, [PC_FAT_TYP] ASC)
    INCLUDE([BF_SSN], [LN_SEQ], [LD_FAT_EFF], [LA_FAT_NSI], [LA_FAT_LTE_FEE], [LA_FAT_CUR_PRI], [PC_FAT_SUB_TYP]);
...
GO
CREATE NONCLUSTERED INDEX [IX_LCFATREVREA_LCSTALON90_PCFATTYP_PCFATSUBTYP]
    ON [dbo].[LN90_FIN_ATY]([LC_FAT_REV_REA] ASC, [LC_STA_LON90] ASC, [PC_FAT_TYP] ASC, [PC_FAT_SUB_TYP] ASC)
    INCLUDE([BF_SSN], [LN_SEQ], [LD_FAT_EFF], [LA_FAT_CUR_PRI]);


GO
CREATE NONCLUSTERED INDEX [IX_LCFATREVREA_LCSTALON90_PCFATTYPE]
    ON [dbo].[LN90_FIN_ATY]([LC_FAT_REV_REA] ASC, [LC_STA_LON90] ASC, [PC_FAT_TYP] ASC, [PC_FAT_SUB_TYP] ASC)
    INCLUDE([BF_SSN], [LN_SEQ], [LN_FAT_SEQ], [LD_FAT_EFF]);

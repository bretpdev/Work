PROC SQL;
CONNECT TO OLEDB as BSYS(init_string="provider=Microsoft OLE DB Provider for SQL Server; 
	Data Source=NOCHOUSE;Initial Catalog=BSYS;Integrated Security=SSPI; update_lock_type=nolock");

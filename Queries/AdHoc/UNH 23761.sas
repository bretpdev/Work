...
/*							AND LN10.LN_SEQ = LN40.LN_SEQ*/
					...
					LEFT JOIN 
						OLWHRM1.LN90_FIN_ATY LN90
							...
							AND LN90.PC_FAT_SUB_TYP IN ('30','31','32')
							AND LN90.LD_FAT_EFF > '07/12/2008'
					WHERE	
						LN10.IF_DOE_LDR = '828476'
						AND
						LN09.LD_LON_RHB_PCV > '07/12/2008'
						AND 
						LN09.LC_RHB_SCH_TYP IS NOT NULL
						AND 
						DAYS(LN90.LD_FAT_EFF) BETWEEN DAYS(LN09.LD_LON_RHB_PCV) + 730 AND DAYS(LN09.LD_LON_RHB_PCV) + 1095
						AND
						(DW01.BF_SSN IS NULL AND DW01.LN_SEQ IS NULL)
...
PROC EXPORT DATA = WORK.DEMO 
            OUTFILE = "T:\SAS\NH 23761 Test File.xlsx" 
            DBMS = EXCEL
			REPLACE;
     SHEET="A"; 
RUN;

...
/*read in MR33 file*/
DATA MR33_;
	INFILE 'T:\SAS\MR-33_Feb 2020.txt';
	INPUT
		SSN_ $ 1-11 
		CLAIM_ID $16-19
		CLID_ $ 25-43
...
/*read in MR34 file*/
DATA MR34_;
	INFILE 'T:\SAS\MR-34_Feb 2020.txt';
	INPUT
		SSN_ $ 1-11 
		CLAIM_ID $16-19
		CLID_ $ 25-43
...
/*read in MR35 file*/
DATA MR35_;
	INFILE 'T:\SAS\MR-35_Feb 2020.txt';
	INPUT
		SSN_ $ 1-11 
		CLAIM_ID $16-19
		CLID_ $ 25-43
...
/*read in MR36 file*/
DATA MR36_;
	INFILE 'T:\SAS\MR-36_Feb 2020.txt';
	INPUT
		SSN_ $ 1-11 
		CLAIM_ID $16-19
		CLID_ $ 25-43
...
/*read in MR37 file*/
DATA MR37_;
	INFILE 'T:\SAS\MR-37_Feb 2020.txt';
	INPUT
		SSN_ $ 1-11 
		CLAIM_ID $16-19
		CLID_ $ 25-43
...
/*read in MR38 file*/
DATA MR38_;
	INFILE 'T:\SAS\MR-38_Feb 2020.txt';
	INPUT
		SSN_ $ 1-11 
		CLAIM_ID $16-19
		CLID_ $ 25-43
...
/*read in MR39 file*/
DATA MR39_;
	INFILE 'T:\SAS\MR-39_Feb 2020.txt';
	INPUT
		SSN_ $ 1-11 
		CLAIM_ID $16-19
		CLID_ $ 25-43
...
/*read in MR40 file*/
DATA MR40_;
	INFILE 'T:\SAS\MR-40_Feb 2020.txt';
	INPUT
		SSN_ $ 1-11 
		CLAIM_ID $16-19
		CLID_ $ 25-43
...
ODS CSV FILE="T:\SAS\UNH 67751.csv";

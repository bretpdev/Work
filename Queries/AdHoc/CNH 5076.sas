...
%BYMON(MONX,'XXNOVXXXX'D);
%BYMON(MONX,'XXDECXXXX'D);
%BYMON(MONX,'XXJANXXXX'D);
%BYMON(MONX,'XXFEBXXXX'D);
%BYMON(MONX,'XXMARXXXX'D);
%BYMON(MONX,'XXAPRXXXX'D);

DATA ALL_MONS;
	SET MONX MONX MONX MONX MONX MONX;
RUN;

...
DATA FINAL;
	SET DID_NOT_RECRT_DELQ RECRT_DUE RECRT_FAILED FAIL_DEF_FORB RECRT_LATE_X RECRT_LATE_X RECRT_LATE_X RECRT_LATE_X RECRT_LATE_X RECRT_LATE_X;
RUN;
...
%CREATE(OUTPUTX, '...within X months', 'X');
%CREATE(OUTPUTX, '...within X months', 'X');
%CREATE(OUTPUTXX, 'Number of borrowers, after failing to recertify on time, failed to recertify within X months and are delinquent', 'XX');
...
DATA TOTALS;
	LENGTH TITLE $XXX.;
	SET OUTPUTX OUTPUTX OUTPUTX OUTPUTX OUTPUTX OUTPUTX OUTPUTX OUTPUTX OUTPUTX OUTPUTXX ALT_FINAL;
RUN; 

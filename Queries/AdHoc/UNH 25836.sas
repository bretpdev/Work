...
FILENAME REPORTZ "&RPTLIB/NH25836.RZ";
FILENAME REPORT2 "&RPTLIB/NH25836.R2";
...
CREATE TABLE LoanDetail AS
	SELECT DISTINCT
		...
		CASE WHEN DW01.WC_DW_LON_STA = '01' THEN 'Loan Status: In Grace'
		...
		CASE WHEN DW01.WC_DW_LON_STA = '01' THEN intnx('day', SD10.LD_SCL_SPR, 1)

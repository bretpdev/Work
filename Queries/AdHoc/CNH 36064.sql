...
BEGIN TRANSACTION
	...
	DECLARE @Disaster VARCHAR(XXX) = 'Georgia Hurricane Michael (DR-XXXX)'
...
--Baker		Decatur		Dougherty	Early		Miller		Seminole	Crisp		Grady		Lee			Mitchell	Terrell		Thomas		Worth		Baker		Calhoun		Clay		Laurens		Randolph	Sumter		Tift		Turner

...
BEGIN TRANSACTION
	...
	DECLARE @Disaster VARCHAR(XXX) = 'South Carolina Hurricane Florence (DR-XXXX)'
	...
	VALUES(@DisasterID_initial, @Disaster, @BeginDate, DATEADD(DAY, XX, @BeginDate), DATEADD(DAY, XXX, @BeginDate), X, 'CNH XXXXX')
	--X

			...
			CONNECTION TO DB2 
				(
					...
					FROM	
						...
						JOIN OLWHRM1.PD10_PRS_NME PD10 ON RS05.BF_SSN = PD10.DF_PRS_ID
					WHERE
						PD10.DF_SPE_ACC_ID IN ('0170038819', '5440820403', '3692609818')
			...
			CONNECTION TO DB2 
				(
					...
					FROM	
						...
						JOIN OLWHRM1.PD10_PRS_NME PD10 ON RS10.BF_SSN = PD10.DF_PRS_ID
					WHERE
						PD10.DF_SPE_ACC_ID IN ('0170038819', '5440820403', '3692609818')
			...
			CONNECTION TO DB2 
				(
					...
					FROM	
						...
						JOIN OLWHRM1.PD10_PRS_NME PD10 ON LN65.BF_SSN = PD10.DF_PRS_ID
					WHERE
						PD10.DF_SPE_ACC_ID IN ('0170038819', '5440820403', '3692609818')

...
DATA DUSTER.SOURCE;
	SET SOURCE;
	SFX = PUT(AF_APL_ID_SFX, $Z2.);
	DROP LF_CRT_DTS_DC10;
RUN;
...
PROC SQL;
	...
	CREATE TABLE DEMO AS
		...
		FROM 
			SOURCE S
			LEFT JOIN OLWHRM1.DC11_LON_FAT DC11
				ON S.AF_APL_ID = DC11.AF_APL_ID
				AND S.SFX = DC11.AF_APL_ID_SFX
	;

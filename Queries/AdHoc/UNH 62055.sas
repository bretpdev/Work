DATA BKY;
	INFILE 'C:\Users\jlwright\Desktop\MR-1\Bankruptcy.txt';
	INPUT
		SSN $ 1-11 
		CLAIM_ID $16-19
...
DATA DEFAULT;
	INFILE 'C:\Users\jlwright\Desktop\MR-1\Default.txt';
	INPUT
		SSN $ 1-11 
		CLAIM_ID $16-19
		PAID_LENDER_ED $ 20-38
...
DATA DTHDIS;
	INFILE 'C:\Users\jlwright\Desktop\MR-1\DeathDis.txt';
	INPUT
		SSN $ 1-11 
		CLAIM_ID $16-19
		PAID_LENDER_ED $ 20-38
...
DATA DISCHARGE;
	INFILE 'C:\Users\jlwright\Desktop\MR-1\Discharge.txt';
	INPUT
		SSN $ 1-11 
		CLAIM_ID $16-19
		PAID_LENDER_ED $ 20-38
...
DATA SCFC;
	INFILE 'C:\Users\jlwright\Desktop\MR-1\SC-FC.txt';
	INPUT
		SSN $ 1-11 
		CLAIM_ID $16-19
		PAID_LENDER_ED $ 20-38
...
DATA WORKLOCL.SCFC; SET SCFC; RUN;
...
ODS CSV FILE="T:\SAS\UNH 62055.csv";

...
BEGIN TRANSACTION
	...
	DECLARE @Disaster VARCHAR(XXX) = 'Nebraska Severe Winter Storm (DR-XXXX)'
...
--Boone		Buffalo	  Butler	Cass	Colfax		Custer	 Dodge		Douglas	  Knox		Nemaha	Richardson	Santee IR	Sarpy	Saunders Thurston  Washington

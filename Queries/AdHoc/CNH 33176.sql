...
WHERE
	DFXX.LC_DFR_TYP = XX
	AND CAST(CAST(DATEDIFF(DAY, LNXX.LD_DFR_BEG, LNXX.LD_DFR_END) AS DECIMAL(XX,X))/XXX*XX AS DECIMAL(XX,X)) > X.XX --@X.XX is the same day of the month six months later

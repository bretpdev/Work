%LET STARTDATE = '4/1/2016';
%LET ENDDATE = '4/30/2016';
%LET NHTIX = NH_27184;
			...
			CONNECTION TO DB2 
				(
					SELECT DISTINCT
						...
						LN40.LD_SBM_CLM_PCL		AS Date_Claim_Filed,
...
/*							AND LN40.LN_SEQ = LN35.LN_SEQ*/
					WHERE
						DAYS(LN40.LD_SBM_CLM_PCL) BETWEEN DAYS(&STARTDATE) AND DAYS(&ENDDATE)

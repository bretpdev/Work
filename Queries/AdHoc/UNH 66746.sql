...
BEGIN TRY
	BEGIN TRANSACTION;
		...
		DECLARE @ROWCOUNT INT = 0
				,@ExpectedRowCount INT = 2150 --# of distinct zips + 1 disaster forb
				,@Disaster VARCHAR(100) = 'COVID-19 Pandemic NY (DR-4480)'
				,@BeginDate DATE = CONVERT(DATE,'20200320') --INCIDENT start date (not declaration date!)
				,@AddedBy VARCHAR(50) = 'UNH 66746' --change to current NH ticket

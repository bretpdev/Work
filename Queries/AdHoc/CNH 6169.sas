PROC IMPORT OUT = WORK.source
            DATAFILE = "T:\CornerStone List GL XX XX XX.xlsx" 
            DBMS = xlsx REPLACE;
   			SHEET = 'SheetX'; 
RUN;
...
/*            OUTFILE = "T:\NH XXXX EX WITH LOAN STATUS.xlsx" */
/*            DBMS = EXCEL*/
/*			REPLACE;*/
/*     SHEET="SheetX"; */
/*RUN;*/
...
WHERE
			...
			OR (LD_DL_CON_INQ < XXX AND LD_DL_CON_INQ IS NOT NULL);
RUN;
...
PROC EXPORT DATA = WORK.REASONS 
            OUTFILE = "T:\NH XXXX EX POP.xlsx" 
            DBMS = EXCEL
			REPLACE;
     SHEET="SheetX"; 
RUN;
...
PROC EXPORT DATA = WORK.VALID_BORROWERS
            OUTFILE = "T:\NH XXXX VALID POP.xlsx" 
            DBMS = EXCEL
			REPLACE;
     SHEET="SheetX"; 
RUN;

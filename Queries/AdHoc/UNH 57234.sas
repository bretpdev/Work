...
/*read in MR33 file*/
DATA MR33_;
	INFILE 'T:\SAS\FSA\MR33_Feb-2018.txt';
	INPUT
		SSN_ $ 1-11 
		CLAIM_ID $16-19
		CLID_ $ 25-43
...
/*read in MR34 file*/
DATA MR34_;
	INFILE 'T:\SAS\FSA\MR34_Feb-2018.txt';
	INPUT
		SSN_ $ 1-11 
		CLAIM_ID $16-19
		CLID_ $ 25-43
...
/*read in MR35 file*/
DATA MR35_;
	INFILE 'T:\SAS\FSA\MR35_Feb-2018.txt';
	INPUT
		SSN_ $ 1-11 
		CLAIM_ID $16-19
		CLID_ $ 25-43
...
/*read in MR36 file*/
DATA MR36_;
	INFILE 'T:\SAS\FSA\MR36_Feb-2018.txt';
	INPUT
		SSN_ $ 1-11 
		CLAIM_ID $16-19
		CLID_ $ 25-43
...
/*read in MR37 file*/
DATA MR37_;
	INFILE 'T:\SAS\FSA\MR37_Feb-2018.txt';
	INPUT
		SSN_ $ 1-11 
		CLAIM_ID $16-19
		CLID_ $ 25-43
...
/*read in MR38 file*/
DATA MR38_;
	INFILE 'T:\SAS\FSA\MR38_Feb-2018.txt';
	INPUT
		SSN_ $ 1-11 
		CLAIM_ID $16-19
		CLID_ $ 25-43
...
/*read in MR39 file*/
DATA MR39_;
	INFILE 'T:\SAS\FSA\MR39_Feb-2018.txt';
	INPUT
		SSN_ $ 1-11 
		CLAIM_ID $16-19
		CLID_ $ 25-43
...
/*read in MR40 file*/
DATA MR40_;
	INFILE 'T:\SAS\FSA\MR40_Feb-2018.txt';
	INPUT
		SSN_ $ 1-11 
		CLAIM_ID $16-19
		CLID_ $ 25-43
...
ODS CSV FILE="T:\SAS\FSA\UNH 57234.csv";

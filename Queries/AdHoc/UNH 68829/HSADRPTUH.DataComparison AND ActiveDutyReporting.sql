...
----INSERT INTO ULS.scra.ActiveDutyReporting(BorrSSN, EndrSSN, IsEndorser, TXCXBegin, TXCXEnd, TXCXType, ServiceComponent, TXCXUpdated, CreatedAt, CreatedBy, DeletedAt, DeletedBy, ErroredAt)
--SELECT DISTINCT
--	NEWDATA.BorrSSN,
--	NEWDATA.EndrSSN,
--	NEWDATA.IsEndorser,

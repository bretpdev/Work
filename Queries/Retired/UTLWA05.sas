/*UTLWA05 QUARTERLY CALCULATED ORIGINATION FEES ON OUTSTANDING LOANS SERVICED BY UHEAA*/
...
VAR LON_CT ORG_FEE;
LABEL LON_CT="NUMBER OF LOANS" ORG_FEE="CALCULATED ORIGINATION FEES OUTSTANDING";
FORMAT LON_CT COMMA9. ORG_FEE DOLLAR14.2;
TITLE 'CALCULATED ORIGINATION FEES OUTSTANDING';
TITLE2 "AT QUARTER-END &END";

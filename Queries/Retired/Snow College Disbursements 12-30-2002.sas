/*IDENTIFY ALL Snow College DISBURSEMENTS SCHEDULED FOR 12/30/02*/
...
AND A.AF_APL_OPS_SCL in ('00367900', '00367901')
AND C.AC_DSB_ADJ_STA = 'A' /*ACTIVE GA11 ROW*/
AND C.AD_DSB_ADJ = '2002-12-30'
...
DATA SCDISBS; 
SET WORKLOCL.SCDISBS; 
RUN;

*WRITE LPP FILE;
data _null_ ;
set  WORK.SCdisbs                                end=EFIEOD;
where AF_CUR_LON_OPS_LDR NE '817455';
%let _EFIERR_ = 0; /* set the ERROR detection macro variable */
%let _EFIREC_ = 0;     /* clear export record count macro variable */
file 'T:\SAS\SCDisb - LPP.txt' delimiter=',' DSD DROPOVER lrecl=32767;
   format SSN $9. ;
   format AF_APL_ID $17. ;
...
%let _EFIERR_ = 0; /* set the ERROR detection macro variable */
%let _EFIREC_ = 0;     /* clear export record count macro variable */
file 'T:\SAS\SCDisb - ZIONS.txt' delimiter=',' DSD DROPOVER lrecl=32767;
   format SSN $9. ;
   format AF_APL_ID $17. ;
   format AF_APL_ID_SFX $2.;
 do;

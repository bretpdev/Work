...
These reports give totals for weekly preclaims filed.
...
filename report2  "&rptlib/ULWDP0.LWDP0R2"  ;
filename report3  "&rptlib/ULWDP0.LWDP0R3"  ;
   ...
   %if &hasobs=1 %then
      %do;
         PROC TABULATE DATA=&dsname;
               ...
               TITLE1 'Number and Dollar of Preclaims Created Last Week';

/*UTLWE01 - BANKONE MR52 DATA FILE*/
/*LIBNAME DLGSUTWH DB2 DATABASE=DLGSUTWH OWNER=OLWHRM1;
%LET RPTLIB = %SYSGET(reportdir);
FILENAME REPORT2 "&RPTLIB/ULWE01.LWE01R2";*/

LIBNAME  WORKLOCL  REMOTE  SERVER=CYPRUS  SLIBREF=WORK;
RSUBMIT;
PROC SQL;
CONNECT TO DB2 (DATABASE=DLGSUTWH);
CREATE TABLE MR52DD AS
SELECT *
...
WHERE 	B.IF_OWN = '819628'
AND 	B.LC_STA_LON35 = 'A'
);
DISCONNECT FROM DB2;
ENDRSUBMIT;
...
PROC SORT DATA=MR52DD;
BY BF_SSN;
RUN;

DATA _NULL_;
SET  WORK.MR52DD;
FILE 'T:\SAS\ULWE01.LWE01R2' delimiter=',' DSD DROPOVER lrecl=32767;

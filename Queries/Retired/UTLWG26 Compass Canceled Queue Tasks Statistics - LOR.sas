/*UTLWG26 LOAN ORIGINATION CANCELLED TASKS QUEUE STATISTICS*/

/*LIBNAME DLGSUTWH DB2 DATABASE=DLGSUTWH OWNER=OLWHRM1;
%LET RPTLIB = %SYSGET(reportdir);
FILENAME REPORT2 "&RPTLIB/ULWG26.LWG26R2";*/

LIBNAME  WORKLOCL  REMOTE  SERVER=CYPRUS  SLIBREF=WORK;
RSUBMIT;
PROC SQL;
CONNECT TO DB2 (DATABASE=DLGSUTWH);
CREATE TABLE LOCTQS AS
SELECT *
...
TITLE 'LOR - CANCELLED TASKS QUEUE STATISTICS';
TITLE2 "Run Date: &FDATE";
PROC CONTENTS DATA=LOCTQS OUT=EMPTYSET NOPRINT;
DATA _NULL_;
SET EMPTYSET;
FILE PRINT;
...
RETURN;
RUN;
PROC PRINT NOOBS SPLIT='/' DATA=LOCTQS WIDTH=UNIFORM N="TOTAL: ";
BY LF_PRF_BY ;
VAR WF_QUE
	WM_QUE_FUL
	WF_SUB_QUE
...
FOOTNOTE  'JOB = UTLWG26  	 REPORT = ULWG26.LWG26R2';
RUN;

/* DISCLOSURE PRINT JOB - LOANS BETWEEN GUARANTEE AND DISBURSEMENT
This job requires running the PRF query UT00016.INTERIM_DISC, and
saving the comma-delimited output file from running the associated
form in the "C:\Windows\Temp directory" as "ziondisc.txt".

*** NOTE *** This job can take over 30 minutes to run!

This job creates the following output files in 'C:\Windows\Temp\':
ULWO01.LWO01R2 = All Stafford loans with valid addresses
ULWO01.LWO01R3 = All Staffords with invalid address
ULWO01.LWO01R4 = All Westminster Staffords, regardless of address validity
ULWO01.LWO01R5 = All Plus loans with valid address
ULWO01.LWO01R6 = All Plus loans with invalid address
ULWO01.LWO01R7 = Westminster Plus loans regardless of valid address
ULWO01.LWO01R8 = Paper Report of all invalid addresses
*/

FILENAME REPORT2 "C:\WINDOWS\TEMP\ULWO01.LWO01R2";
FILENAME REPORT3 "C:\WINDOWS\TEMP\ULWO01.LWO01R3";
FILENAME REPORT4 "C:\WINDOWS\TEMP\ULWO01.LWO01R4";
FILENAME REPORT5 "C:\WINDOWS\TEMP\ULWO01.LWO01R5";
FILENAME REPORT6 "C:\WINDOWS\TEMP\ULWO01.LWO01R6";
FILENAME REPORT7 "C:\WINDOWS\TEMP\ULWO01.LWO01R7";

data WORK.ZIONS                                  ;
%let _EFIERR_ = 0; /* set the ERROR detection macro variable */
infile 'C:\Windows\Temp\ziondisc.txt' delimiter = ',' MISSOVER DSD lrecl=32767 firstobs=2 ;
   informat SSN $9. ;
   informat AP_SEQ $5. ;
   informat LC_CMN_LN_HLD_RLS $1. ;
   informat AF_LON_ALT $17. ;
   informat AN_SEQ_COM_LN_APL $2. ;
   format SSN $9. ;
   format AP_SEQ $5. ;
   format LC_CMN_LN_HLD_RLS $1. ;
   format AF_LON_ALT $17. ;
   format AN_SEQ_COM_LN_APL $2. ;
input
            SSN $
            AP_SEQ $
            LC_CMN_LN_HLD_RLS $
...
DATA WORKLOCL.ZIONS;
SET ZIONS (KEEP = SSN AF_LON_ALT AN_SEQ_COM_LN_APL);
RUN;
...
/*INNER JOIN 
	(SELECT	B.AF_LON_ALT
		,'0'||CHAR(B.AN_SEQ_COM_LN_APL) AS AN_SEQ_COM_LN_APL
	...
	WHERE A.LC_STA_LON15 IN ('1','3')
		...
		AND A.LN_LON_DSB_SEQ = 1) H
	ON B.AF_APL_ID = H.AF_LON_ALT
	AND B.AF_APL_ID_SFX = H.AN_SEQ_COM_LN_APL*/
...
/*SELECT LOAN POPULATION FROM COMPASS*/
CREATE TABLE LPPS AS
SELECT *
FROM CONNECTION TO DB2 (
SELECT	B.AF_LON_ALT
		,'0'||CHAR(B.AN_SEQ_COM_LN_APL) AS AN_SEQ_COM_LN_APL
...
RUN;
PROC SORT DATA=DISC;
BY AF_LON_ALT AN_SEQ_COM_LN_APL;
RUN;
...
SELECT B.*
FROM DISC A
INNER JOIN DISCALL B
	ON A.AF_LON_ALT||A.AN_SEQ_COM_LN_APL = B.CLUID
ORDER BY B.LDR_ID, B.DF_PRS_ID_BR, B.CLUID;
QUIT;
...
*Westminster Stafford loans;
DATA DISCGL_WEST;
SET DISCGL;
WHERE SCL_ID = '00368100';
RUN;

*Westminster Plus loans;
DATA DISCPL_WEST;
SET DISCPL;
WHERE SCL_ID = '00368100';
RUN;
...
data _null_ ;
set  WORK.Discgl (where = (DI_VLD_ADR = 'Y')) end=EFIEOD;
%let _EFIERR_ = 0; /* set the ERROR detection macro variable */
%let _EFIREC_ = 0;     /* clear export record count macro variable */
file 'C:\Windows\Temp\ULWO01.LWO01R2' delimiter=',' DSD DROPOVER lrecl=32767;
...
*All Staffords with invalid address;
data _null_ ;
set  WORK.Discgl (where = (DI_VLD_ADR = 'N')) end=EFIEOD;
%let _EFIERR_ = 0; /* set the ERROR detection macro variable */
%let _EFIREC_ = 0;     /* clear export record count macro variable */
file 'C:\Windows\Temp\ULWO01.LWO01R3' delimiter=',' DSD DROPOVER lrecl=32767;
...
*All Westminster Staffords, regardless of address validity;
data _null_ ;
set  WORK.Discgl_west end=EFIEOD;
%let _EFIERR_ = 0; /* set the ERROR detection macro variable */
%let _EFIREC_ = 0;     /* clear export record count macro variable */
file 'C:\Windows\Temp\ULWO01.LWO01R4' delimiter=',' DSD DROPOVER lrecl=32767;
...
data _null_;
set  WORK.Discpl  (where = (DI_VLD_ADR = 'Y')) end=EFIEOD;
%let _EFIERR_ = 0; /* set the ERROR detection macro variable */
%let _EFIREC_ = 0;     /* clear export record count macro variable */
file 'C:\Windows\Temp\ULWO01.LWO01R5' delimiter=',' DSD DROPOVER lrecl=32767;
...
data _null_;
set  WORK.Discpl (where = (DI_VLD_ADR = 'N')) end=EFIEOD;
%let _EFIERR_ = 0; /* set the ERROR detection macro variable */
%let _EFIREC_ = 0;     /* clear export record count macro variable */
file 'C:\Windows\Temp\ULWO01.LWO01R6' delimiter=',' DSD DROPOVER lrecl=32767;
...
data _null_;
set  WORK.Discpl_west  end=EFIEOD;
%let _EFIERR_ = 0; /* set the ERROR detection macro variable */
%let _EFIREC_ = 0;     /* clear export record count macro variable */
file 'C:\Windows\Temp\ULWO01.LWO01R7' delimiter=',' DSD DROPOVER lrecl=32767;

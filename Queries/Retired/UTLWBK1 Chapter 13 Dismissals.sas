/*	THIS REPORT IS NO LONGER REQUIRED. INFO IS DUPLICATED ON ULWBK3.LWBK3R2.
...
PROC PRINT SPLIT='/' DATA = WORKLOCL.DEANA n='Total number of accounts = ' NOOBS;
...
title2 'with no review in the last 30 days.';
label	FILEDT = 'Filing Date' 
		MAXREVIEW = 'Last Review Date';
where STATUS = '01' AND CHAPCODE = '04';
FOOTNOTE  'JOB = UTLWBK1     REPORT = ULWBK1.LWBK1R2';
RUN;

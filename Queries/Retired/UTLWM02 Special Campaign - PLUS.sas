...
FILENAME REPORT2 "C:\WINDOWS\TEMP\ULWM02.LWM02R2";
FILENAME REPORT3 "C:\WINDOWS\TEMP\ULWM02.LWM02R3";
FILENAME REPORT4 "C:\WINDOWS\TEMP\ULWM02.LWM02R4";
FILENAME REPORT5 "C:\WINDOWS\TEMP\ULWM02.LWM02R5";
libname  WORKLOCL  REMOTE  SERVER=CYPRUS  SLIBREF=work  ;
RSUBMIT;

PROC SQL STIMER;
CONNECT TO DB2 (DATABASE=DLGSUTWH);
CREATE TABLE SCPL1A AS
SELECT *
...
ENDRSUBMIT;
DATA SCPL1; SET WORKLOCL.SCPL1; RUN;
DATA SCPL2; SET WORKLOCL.SCPL2; RUN;
DATA SCPL3; SET WORKLOCL.SCPL3; RUN;

...
ULWO01.LWO01R11 = UCMT Plus loans regardless of valid address
*/
...
*READ LAST RUN DATE FOR UTLWG01 FROM CYPRUS DATASET;
*LIBNAME OLRPLD V8 '/sas/whse/guaranty'; 				*CYPRUS TEST;

/*UTLWS10 BSV CANCELLED TASKS QUEUE STATISTICS*/
LIBNAME DLGSUTWH DB2 DATABASE=DLGSUTWH OWNER=OLWHRM1;
%LET RPTLIB = %SYSGET(reportdir);
FILENAME REPORT2 "&RPTLIB/ULWS10.LWS10R2";
/*LIBNAME  WORKLOCL  REMOTE  SERVER=CYPRUS  SLIBREF=WORK;*/
/*RSUBMIT;*/
PROC SQL;
CONNECT TO DB2 (DATABASE=DLGSUTWH);
CREATE TABLE BSCTQS AS
SELECT *
...
TITLE 'BSV CANCELLED TASKS QUEUE STATISTICS';;
TITLE2 "Run Date: &CURDATE";
PROC CONTENTS DATA=BSCTQS OUT=EMPTYSET NOPRINT;
DATA _NULL_;
SET EMPTYSET;
FILE PRINT;
IF  NOBS=0 AND _N_ =1 THEN DO;
	...
	PUT ////////
		@57 '-- END OF REPORT --';
	PUT ////////////////
		@46 "JOB = UTLWS10  	 REPORT = ULWS10.LWS10R2";
	END;
RETURN;
RUN;
PROC PRINT NOOBS SPLIT='/' DATA=BSCTQS WIDTH=UNIFORM N="TOTAL: ";
BY LF_PRF_BY ;
VAR WF_QUE
	WM_QUE_FUL
	WF_SUB_QUE
...
FOOTNOTE  'JOB = UTLWS10  	 REPORT = ULWS10.LWS10R2';
RUN;

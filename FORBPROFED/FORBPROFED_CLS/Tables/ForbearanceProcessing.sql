CREATE TABLE [forb].[ForbearanceProcessing](
...
ALTER TABLE [forb].[ForbearanceProcessing] ADD  DEFAULT ((1)) FOR [SelectAllLoans]
GO

ALTER TABLE [forb].[ForbearanceProcessing] ADD  DEFAULT (NULL) FOR [ForbearanceProcessedOn]
GO

ALTER TABLE [forb].[ForbearanceProcessing] ADD  DEFAULT (suser_name()) FOR [AddedBy]
GO

ALTER TABLE [forb].[ForbearanceProcessing] ADD  DEFAULT (getdate()) FOR [AddedAt]
GO

ALTER TABLE [forb].[ForbearanceProcessing] ADD  DEFAULT (NULL) FOR [DeletedBy]
GO

ALTER TABLE [forb].[ForbearanceProcessing] ADD  DEFAULT (NULL) FOR [DeletedAt]
GO

ALTER TABLE [forb].[ForbearanceProcessing]  WITH NOCHECK ADD FOREIGN KEY([BusinessUnitId])
REFERENCES [forb].[BusinessUnits] ([BusinessUnitId])
GO

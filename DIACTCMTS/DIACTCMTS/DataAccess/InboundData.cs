...
namespace DIACTCMTS
{
    ...
    {
        [DbName("rowid")]
        public long NobleRowId { get; set; }
        [DbName("call_type")]
        ...
        public string AccountIdentifier
        {
            get
            {
                return (accountIdentifer.IsPopulated() ? accountIdentifer.Trim().Replace(" ", "") : accountIdentifer);
            }
            set
            {
                accountIdentifer = value;
            }
        }
        [DbName("ani_acode")]
        ...
        [DbName("call_time")] //This is no longer used and can be updated on the next request
        ...
        public void CleanseData()
        {
            ...
            EffectiveTime = EffectiveTime.IsPopulated() ? EffectiveTime.PadLeft(6, '0').Replace(":", "") : null;

...
Public Class frmScriptsAndServicesDeferForbHistory
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmScriptsAndServicesDeferForbHistory))
        ...
        Me.Name = "frmScrServDeferForbHistory"
...
#End Region
    ...
    Public Sub Process()
        ...
        If LVHist.Items.Count = 0 Then
            ...
            End If
        End If
        'remove duplicates in list view (roll up)
        While I < LVHist.Items.Count
            I1 = (I + 1)
            While I1 < LVHist.Items.Count
                If LVHist.Items(I).SubItems(0).Text = LVHist.Items(I1).SubItems(0).Text And _
                   LVHist.Items(I).SubItems(1).Text = LVHist.Items(I1).SubItems(1).Text And _
                   LVHist.Items(I).SubItems(2).Text = LVHist.Items(I1).SubItems(2).Text Then
                    LVHist.Items.RemoveAt(I1)
                Else
                    I1 += 1
                End If
            End While

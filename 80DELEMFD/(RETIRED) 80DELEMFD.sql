...
DECLARE @EmailCampaign VARCHAR(20) = '80DLQPSFED.html' --Letter Id For Email Campaigns Table
DECLARE @SasId VARCHAR(20) = '80DELEMFD'
...
WHERE
	...
	(
		(
			@DateName = 'Monday'
			AND LN16.LN_DLQ_MAX + 1 BETWEEN  80 and 82
			AND LN16.LC_STA_LON16 = 1
		)
		OR
		(
			@DateName != 'Monday' --It is not necessary, but it is more clear
			AND LN16.LN_DLQ_MAX + 1 = 80
			AND LN16.LC_STA_LON16 = 1
		)
	)

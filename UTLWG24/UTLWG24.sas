/*UTLWG24 - BORROWERS DISQUALIFIED FOR DIRECT DEBIT*/
/*LIBNAME DLGSUTWH DB2 DATABASE=DLGSUTWH OWNER=OLWHRM1;*/
/*%LET RPTLIB = %SYSGET(reportdir);*/
%LET RPTLIB = T:\SAS;
FILENAME REPORT2 "&RPTLIB/ULWG24.LWG24R2";
...
PROC TRANSPOSE DATA=DDQ OUT=DDQ (KEEP=DF_SPE_ACC_ID BF_SSN PF_REQ_ACT LC_STA_ACTY10 DM_PRS_1 DM_PRS_LST ADATE1 ADATE2
	WHERE=(ADATE2 ^= . AND INTNX('YEAR',ADATE1,+1,'S') > TODAY())) PREFIX=ADATE;
VAR LD_STA_ACTY10;
...
DATA DDQ;
SET DDQ;
IF ADATE2 >= ADATE1 - 365 THEN OUTPUT;
RUN;
...
IF  NOBS=0 AND _N_ =1 THEN DO;
	...
	PUT ////////
		@57 '-- END OF REPORT --';
	PUT ////////////////
		@46 "JOB = UTLWG24     REPORT = ULWG24.LWG24R2";
	END;
RETURN;
RUN;
...
FOOTNOTE 'JOB = UTLWG24     REPORT = ULWG24.LWG24R2';
RUN;
PROC PRINTTO;
RUN;

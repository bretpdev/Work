...
{
    public class ProcessExtensionSameName
    {
        ...
        public void Start()
        {
            ...
            WriteLine("Copying properties with matching name extension method.");
            WriteLine("");

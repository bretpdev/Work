...
FROM
	...
	INNER JOIN AY10_BR_LON_ATY AY10
		ON AY10.BF_SSN = Borr.DF_PRS_ID
		AND AY10.LN_ATY_SEQ = BorrLt20.RN_ATY_SEQ_PRC
	...
	LEFT JOIN LT20_LTR_REQ_PRC_Coborrower EndrLt20
		...
		AND EndrLt20.Borrower_DF_SPE_ACC_ID = BorrLt20.DF_SPE_ACC_ID
...
WHERE
	...
	AND SLR.LetterId IS NULL
	AND AY10.LF_ATY_RCP = BorrLt20.RF_SBJ_PRC 

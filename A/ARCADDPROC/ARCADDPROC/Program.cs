...
namespace ARCADDPROCESSING
{
    ...
    {
        const string ScriptId = "ARCADDPROC";
        ...
        static int Main(string[] args)
        {
            ...
            ProcessLogRun logRunUheaa = new ProcessLogRun(ScriptId, AppDomain.CurrentDomain, Assembly.GetExecutingAssembly(), DataAccessHelper.Region.Uheaa, DataAccessHelper.CurrentMode, false, true, true);
            ...
            threads.Add(Task.Factory.StartNew(() => uheaaReturnValue = new ArcAddProcessing(logRunUheaa, ScriptId).ProcessArcs(sessionCount), TaskCreationOptions.LongRunning));

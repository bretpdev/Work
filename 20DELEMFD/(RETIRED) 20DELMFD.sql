...
DECLARE @EmailCampaign VARCHAR(20) = 'DUEDATEFED.html'--Letter Id For Email Campaigns Table
DECLARE @SasId VARCHAR(20) = '20DELEMFD'
...
WHERE
	...
	(
		(
			@DateName = 'Monday'
			AND LN16.LN_DLQ_MAX + 1 BETWEEN  20 and 22
			AND LN16.LC_STA_LON16 = 1
		)
		OR
		(
			@DateName != 'Monday' --It is not necessary, but it is more clear
			AND LN16.LN_DLQ_MAX + 1 = 20
			AND LN16.LC_STA_LON16 = 1
		)
	)

...
{
	class CompassPdemParser : IDemographicsParser
	{
		private ReflectionInterface RI { get; set; }
		public CompassPdemParser(ReflectionInterface ri)
		{
			RI = ri;
		}
		...
		{
			QueueTask pdem = new QueueTask(RejectAction.Sources.COMPASS_PENDING_PDEM, SystemCode.Sources.COMPASS);

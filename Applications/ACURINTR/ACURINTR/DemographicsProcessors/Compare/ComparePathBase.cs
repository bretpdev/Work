...
namespace ACURINTR.DemographicsProcessors
{
	abstract class ComparePathBase : ProcessingPathBase
	{
		...
		protected ComparePathBase(ReflectionInterface ri, string demographicsReviewQueue, string foreignDemographicsQueue, ProcessLogData logData, string userid, string scriptId)

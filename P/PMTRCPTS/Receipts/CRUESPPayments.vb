...
Public Class CRUESPPayments
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Receipts.CRUESPPayments.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRUESPPayments
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRUESPPayments = New CRUESPPayments
        rpt.Site = Me.Site
        Return rpt
    End Function

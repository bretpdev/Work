...
Public Class rptPaymentReceipts
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Receipts.rptPaymentReceipts.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPaymentReceipts
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPaymentReceipts = New rptPaymentReceipts
        rpt.Site = Me.Site
        Return rpt
    End Function

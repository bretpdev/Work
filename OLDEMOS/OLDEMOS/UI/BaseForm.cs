...
namespace OLDEMOS
{
    public partial class BaseForm : Form
    {
        ...
        {
            mdOrdinal = ordinal;
            foreach (BaseForm bf in Helper.UI.Forms)
                bf.UpdateTitle();
        }
        ...
        {
            Helper.UI.RemoveForm(this);
            if (!Helper.UI.Forms.Any())
            {
                new Thread(() => Helper.UI.QuitApplication()).Start();
            }
            base.OnClosed(e);
        }
        ...
        public void ApplyContrast()
        {
            ...
            {
                case CommonMenu.ContrastModeEnum.Normal:
                    NormalContrast();
                    break;
                case CommonMenu.ContrastModeEnum.HighContrast:
                    HighContrast();
                    break;
                case CommonMenu.ContrastModeEnum.Professional:

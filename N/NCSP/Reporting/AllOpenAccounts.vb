...
Public Class AllOpenAccounts
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NCSP.AllOpenAccounts.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAllOpenAccounts
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AllOpenAccounts = New AllOpenAccounts
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class RefundDueStudents
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NCSP.RefundDueStudents.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRefundDueStudents
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RefundDueStudents = New RefundDueStudents
        rpt.Site = Me.Site
        Return rpt
    End Function

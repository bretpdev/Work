...
%LET RPTLIB = T:\SAS;
FILENAME REPORT2 "&RPTLIB/ULWS55.LWS55R2";
...
SELECT A.DF_SPE_ACC_ID
	...
	,CASE
		...
		ELSE '2'
	END AS EML_CODE
FROM DLGSUTWH.DF10_BR_DFR_REQ B 
...
WHERE B.LC_DFR_STA = 'A'
	AND B.LC_STA_DFR10 = 'A'
	AND B.LD_CRT_REQ_DFR >= TODAY()-30
	AND B.LC_DFR_TYP NOT IN ('15','16','18')

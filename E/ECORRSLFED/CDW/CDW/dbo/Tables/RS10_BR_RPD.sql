CREATE TABLE [dbo].[RS10_BR_RPD] (
    ...
    [LF_USR_RPS_REQ]     VARCHAR (50)  NOT NULL,
    [LN_BR_REQ_DU_DAY]   CHAR (2)      NOT NULL,
    [BD_CRT_RS05]        DATE          NULL,
    [BN_IBR_SEQ]         SMALLINT      NULL,
    [LC_RPY_FIX_TRM_AMT] CHAR (1)      NOT NULL,
    [LC_CAP_TRG_LVE_PFH] VARCHAR (50)  NOT NULL,
    CONSTRAINT [PK_RS10_BR_RPD] PRIMARY KEY CLUSTERED ([BF_SSN] ASC, [LN_RPS_SEQ] ASC)
);
...
GO
CREATE NONCLUSTERED INDEX [BFSSN_BDCRTRS05]
    ON [dbo].[RS10_BR_RPD]([BF_SSN] ASC, [BD_CRT_RS05] ASC);

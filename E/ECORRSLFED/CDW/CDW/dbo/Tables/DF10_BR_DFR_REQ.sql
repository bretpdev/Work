CREATE TABLE [dbo].[DF10_BR_DFR_REQ] (
    ...
    CONSTRAINT [PK_DF10_BR_DFR_REQ] PRIMARY KEY CLUSTERED ([BF_SSN] ASC, [LF_DFR_CTL_NUM] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IX_LCDFRSTA_LCSTADFR10_LCDFRTYP]
    ON [dbo].[DF10_BR_DFR_REQ]([LC_DFR_STA] ASC, [LC_STA_DFR10] ASC, [LC_DFR_TYP] ASC)
    INCLUDE([BF_SSN], [LF_DFR_CTL_NUM]);


GO
CREATE NONCLUSTERED INDEX [IX_BFSSN_LCSTADFR10>]
    ON [dbo].[DF10_BR_DFR_REQ]([BF_SSN] ASC, [LC_STA_DFR10] ASC);

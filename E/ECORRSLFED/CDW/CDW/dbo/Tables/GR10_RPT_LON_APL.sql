CREATE TABLE [dbo].[GR10_RPT_LON_APL] (
    ...
    [LF_FED_CLC_RSK]     CHAR (6)        NULL,
    [WC_NDS_IDR_PGS_RPT] CHAR (1)        NULL,
    [WD_NDS_IDR_PGS_RPT] DATE            NULL,
    [WN_PRV_RPT_PGS_IBR] NUMERIC (3)     NULL,
    [WN_PRV_RPT_PGS_PYE] NUMERIC (3)     NULL,
    [WN_PRV_RPT_PGS_RPY] NUMERIC (3)     NULL,
    [WN_PRV_RPT_PGS_ICR] NUMERIC (3)     NULL,
    [WC_NDS_ATV_DTY_RPT] CHAR (1)        NULL,
    [WD_NDS_ATV_DTY_RPT] DATE            NULL,
    [WC_NDS_IDG_HSL_RPT] CHAR (1)        NULL,
    [WD_NDS_IDG_HSL_RPT] DATE            NULL,
    CONSTRAINT [PK_GR10_RPT_LON_APL] PRIMARY KEY CLUSTERED ([BF_SSN] ASC, [WN_SEQ_GR10] ASC) WITH (FILLFACTOR = 95)
);

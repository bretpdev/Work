CREATE PROCEDURE [dbo].[LT_TS06BRPYXP_FormFields]
...
DECLARE	@LetterId VARCHAR(10) = 'TS06BRPYXP'
				...
				WHERE
					...
					(
						(
							...
							AND LN65.LC_TYP_SCH_DIS IN('I5', 'RE')
						) --Active CA with a CP pending if no requal
						OR
						(
							LN66.LN_GRD_RPS_SEQ = 1
							AND LN65.LC_TYP_SCH_DIS IN('IA', 'RE')
						)
